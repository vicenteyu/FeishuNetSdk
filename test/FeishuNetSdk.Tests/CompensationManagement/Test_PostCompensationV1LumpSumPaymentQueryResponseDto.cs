...
// ************************************************************************
// <copyright file="Test_PostCompensationV1LumpSumPaymentQueryResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询一次性支付授予记录 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCompensationV1LumpSumPaymentQueryResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.CompensationManagement.PostCompensationV1LumpSumPaymentQueryResponseDto>>(json);
