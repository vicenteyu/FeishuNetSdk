...
// ************************************************************************
// <copyright file="Test_PostCompensationV1RecurringPaymentBatchRemoveResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量删除经常性支付记录 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCompensationV1RecurringPaymentBatchRemoveResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.CompensationManagement.PostCompensationV1RecurringPaymentBatchRemoveResponseDto>>(json);
