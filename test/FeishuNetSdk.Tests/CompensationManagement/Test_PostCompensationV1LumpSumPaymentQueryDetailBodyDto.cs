...
// ************************************************************************
// <copyright file="Test_PostCompensationV1LumpSumPaymentQueryDetailBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询一次性支付授予明细 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCompensationV1LumpSumPaymentQueryDetailBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.CompensationManagement.PostCompensationV1LumpSumPaymentQueryDetailBodyDto>(json);
