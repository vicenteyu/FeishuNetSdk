...
// ************************************************************************
// <copyright file="Test_CorehrCustomOrgUpdatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 自定义组织被更新 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrCustomOrgUpdatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrCustomOrgUpdatedV2EventBodyDto>>(json);
