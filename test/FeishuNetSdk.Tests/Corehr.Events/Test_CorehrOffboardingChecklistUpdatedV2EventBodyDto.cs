...
// ************************************************************************
// <copyright file="Test_CorehrOffboardingChecklistUpdatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 离职流转状态变更 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrOffboardingChecklistUpdatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrOffboardingChecklistUpdatedV2EventBodyDto>>(json);
