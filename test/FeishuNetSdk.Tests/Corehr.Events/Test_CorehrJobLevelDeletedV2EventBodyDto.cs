...
// ************************************************************************
// <copyright file="Test_CorehrJobLevelDeletedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除职级 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrJobLevelDeletedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrJobLevelDeletedV2EventBodyDto>>(json);
