...
// ************************************************************************
// <copyright file="Test_CorehrDepartmentCreatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建部门V2 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrDepartmentCreatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrDepartmentCreatedV2EventBodyDto>>(json);
