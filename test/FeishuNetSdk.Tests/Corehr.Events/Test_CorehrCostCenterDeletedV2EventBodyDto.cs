...
// ************************************************************************
// <copyright file="Test_CorehrCostCenterDeletedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除成本中心 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrCostCenterDeletedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrCostCenterDeletedV2EventBodyDto>>(json);
