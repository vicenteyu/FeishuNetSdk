...
// ************************************************************************
// <copyright file="Test_CorehrProcessUpdatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 流程实例信息变更 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrProcessUpdatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrProcessUpdatedV2EventBodyDto>>(json);
