...
// ************************************************************************
// <copyright file="Test_CorehrCompanyCreatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建公司 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrCompanyCreatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrCompanyCreatedV2EventBodyDto>>(json);
