...
// ************************************************************************
// <copyright file="Test_CorehrCustomOrgDeletedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 自定义组织被删除 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrCustomOrgDeletedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrCustomOrgDeletedV2EventBodyDto>>(json);
