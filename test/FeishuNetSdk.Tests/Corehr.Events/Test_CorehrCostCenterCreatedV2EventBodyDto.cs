...
// ************************************************************************
// <copyright file="Test_CorehrCostCenterCreatedV2EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建成本中心 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrCostCenterCreatedV2EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Corehr.Events.CorehrCostCenterCreatedV2EventBodyDto>>(json);
