...
// ************************************************************************
// <copyright file="Test_PostApprovalOpenapiV2CcSearchResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 抄送列表查询 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostApprovalOpenapiV2CcSearchResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Approval.Spec.PostApprovalOpenapiV2CcSearchResponseDto>>(json);
