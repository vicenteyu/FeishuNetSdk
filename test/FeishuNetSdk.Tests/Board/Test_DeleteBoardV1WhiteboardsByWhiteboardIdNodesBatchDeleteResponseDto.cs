...
// ************************************************************************
// <copyright file="Test_DeleteBoardV1WhiteboardsByWhiteboardIdNodesBatchDeleteResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量删除节点 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_DeleteBoardV1WhiteboardsByWhiteboardIdNodesBatchDeleteResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Board.DeleteBoardV1WhiteboardsByWhiteboardIdNodesBatchDeleteResponseDto>>(json);
