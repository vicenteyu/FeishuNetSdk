...
// ************************************************************************
// <copyright file="Test_ContactEmployeeTypeEnumUpdatedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改人员类型名称 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ContactEmployeeTypeEnumUpdatedV3EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Contact.Events.ContactEmployeeTypeEnumUpdatedV3EventBodyDto>>(json);
