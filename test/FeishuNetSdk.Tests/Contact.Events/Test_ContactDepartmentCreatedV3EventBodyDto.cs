...
// ************************************************************************
// <copyright file="Test_ContactDepartmentCreatedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 部门新建 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ContactDepartmentCreatedV3EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Contact.Events.ContactDepartmentCreatedV3EventBodyDto>>(json);
