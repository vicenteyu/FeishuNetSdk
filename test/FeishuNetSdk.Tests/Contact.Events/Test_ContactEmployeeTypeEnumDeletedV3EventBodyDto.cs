...
// ************************************************************************
// <copyright file="Test_ContactEmployeeTypeEnumDeletedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除人员类型 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ContactEmployeeTypeEnumDeletedV3EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Contact.Events.ContactEmployeeTypeEnumDeletedV3EventBodyDto>>(json);
