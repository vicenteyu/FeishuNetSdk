...
// ************************************************************************
// <copyright file="Test_GetLingoV1EntitiesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取词条列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetLingoV1EntitiesResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Baike.GetLingoV1EntitiesResponseDto>>(json);
