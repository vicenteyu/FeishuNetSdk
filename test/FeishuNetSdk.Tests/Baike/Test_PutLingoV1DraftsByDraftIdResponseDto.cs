...
// ************************************************************************
// <copyright file="Test_PutLingoV1DraftsByDraftIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PutLingoV1DraftsByDraftIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Baike.PutLingoV1DraftsByDraftIdResponseDto>>(json);
