...
// ************************************************************************
// <copyright file="Test_PostLingoV1DraftsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PostLingoV1DraftsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Baike.PostLingoV1DraftsBodyDto>(json);
