...
// ************************************************************************
// <copyright file="Test_PostBaikeV1EntitiesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建免审词条 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostBaikeV1EntitiesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Baike.PostBaikeV1EntitiesBodyDto>(json);
