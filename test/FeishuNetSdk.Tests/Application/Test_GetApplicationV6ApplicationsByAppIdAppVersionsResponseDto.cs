...
// ************************************************************************
// <copyright file="Test_GetApplicationV6ApplicationsByAppIdAppVersionsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取应用版本列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetApplicationV6ApplicationsByAppIdAppVersionsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Application.GetApplicationV6ApplicationsByAppIdAppVersionsResponseDto>>(json);
