...
// ************************************************************************
// <copyright file="Test_PatchDriveV1PermissionsByTokenPublicBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PatchDriveV1PermissionsByTokenPublicBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Ccm.PatchDriveV1PermissionsByTokenPublicBodyDto>(json);
