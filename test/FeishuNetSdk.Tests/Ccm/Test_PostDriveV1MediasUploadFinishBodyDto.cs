...
// ************************************************************************
// <copyright file="Test_PostDriveV1MediasUploadFinishBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 分片上传素材-完成上传 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostDriveV1MediasUploadFinishBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Ccm.PostDriveV1MediasUploadFinishBodyDto>(json);
