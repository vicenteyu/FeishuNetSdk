...
// ************************************************************************
// <copyright file="Test_GetWikiV2SpacesGetNodeResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取知识空间节点信息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetWikiV2SpacesGetNodeResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Ccm.GetWikiV2SpacesGetNodeResponseDto>>(json);
