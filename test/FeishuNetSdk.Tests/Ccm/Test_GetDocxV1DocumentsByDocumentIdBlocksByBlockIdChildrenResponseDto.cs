...
// ************************************************************************
// <copyright file="Test_GetDocxV1DocumentsByDocumentIdBlocksByBlockIdChildrenResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取所有子块 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetDocxV1DocumentsByDocumentIdBlocksByBlockIdChildrenResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Ccm.GetDocxV1DocumentsByDocumentIdBlocksByBlockIdChildrenResponseDto>>(json);
