...
// ************************************************************************
// <copyright file="Test_PutWikiV2SpacesBySpaceIdSettingBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新知识空间设置 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutWikiV2SpacesBySpaceIdSettingBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Ccm.PutWikiV2SpacesBySpaceIdSettingBodyDto>(json);
