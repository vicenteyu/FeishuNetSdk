...
// ************************************************************************
// <copyright file="Test_PostTranslationV1TextDetectResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 识别文本语种 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostTranslationV1TextDetectResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Ai.PostTranslationV1TextDetectResponseDto>>(json);
