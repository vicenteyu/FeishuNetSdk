...
// ************************************************************************
// <copyright file="Test_PostOpticalCharRecognitionV1ImageBasicRecognizeResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 识别图片中的文字 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostOpticalCharRecognitionV1ImageBasicRecognizeResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Ai.PostOpticalCharRecognitionV1ImageBasicRecognizeResponseDto>>(json);
