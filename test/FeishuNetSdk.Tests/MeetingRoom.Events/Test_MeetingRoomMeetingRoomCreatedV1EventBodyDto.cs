...
// ************************************************************************
// <copyright file="Test_MeetingRoomMeetingRoomCreatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 会议室创建 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_MeetingRoomMeetingRoomCreatedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.MeetingRoom.Events.MeetingRoomMeetingRoomCreatedV1EventBodyDto>>(json);
