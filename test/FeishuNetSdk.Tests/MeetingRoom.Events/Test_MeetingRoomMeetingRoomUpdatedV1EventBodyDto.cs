...
// ************************************************************************
// <copyright file="Test_MeetingRoomMeetingRoomUpdatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 会议室属性变更 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_MeetingRoomMeetingRoomUpdatedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.MeetingRoom.Events.MeetingRoomMeetingRoomUpdatedV1EventBodyDto>>(json);
