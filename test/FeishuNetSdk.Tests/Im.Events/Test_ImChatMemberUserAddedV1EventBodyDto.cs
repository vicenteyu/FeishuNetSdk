...
// ************************************************************************
// <copyright file="Test_ImChatMemberUserAddedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 用户进群 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ImChatMemberUserAddedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImChatMemberUserAddedV1EventBodyDto>>(json);
