...
// ************************************************************************
// <copyright file="Test_ImChatDisbandedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 群解散 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ImChatDisbandedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImChatDisbandedV1EventBodyDto>>(json);
