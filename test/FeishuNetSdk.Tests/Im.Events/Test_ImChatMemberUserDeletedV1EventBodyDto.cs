...
// ************************************************************************
// <copyright file="Test_ImChatMemberUserDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 用户出群 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ImChatMemberUserDeletedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImChatMemberUserDeletedV1EventBodyDto>>(json);
