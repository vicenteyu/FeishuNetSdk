...
/// </summary>
[TestClass]
public class Test_ImMessageReceiveV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImMessageReceiveV1EventBodyDto>>(json);
