...
// ************************************************************************
// <copyright file="Test_ImChatMemberUserWithdrawnV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 撤销拉用户进群 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ImChatMemberUserWithdrawnV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImChatMemberUserWithdrawnV1EventBodyDto>>(json);
