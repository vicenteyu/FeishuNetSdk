...
// ************************************************************************
// <copyright file="Test_ImMessageReactionDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除消息表情回复 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_ImMessageReactionDeletedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Im.Events.ImMessageReactionDeletedV1EventBodyDto>>(json);
