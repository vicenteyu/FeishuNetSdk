...
// ************************************************************************
// <copyright file="Test_PostAuthenV1AccessTokenResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取 user_access_token（v1 版本） 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Tests.Auth;

/// <summary>
/// 测试 获取 user_access_token（v1 版本） 响应体
...
/// </summary>
[TestClass]
public class Test_PostAuthenV1AccessTokenResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Auth.PostAuthenV1AccessTokenResponseDto>>(json);
