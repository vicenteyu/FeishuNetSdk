...
// ************************************************************************
// <copyright file="Test_PostDirectoryV1DepartmentsFilterResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量获取部门列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostDirectoryV1DepartmentsFilterResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Directory.PostDirectoryV1DepartmentsFilterResponseDto>>(json);
