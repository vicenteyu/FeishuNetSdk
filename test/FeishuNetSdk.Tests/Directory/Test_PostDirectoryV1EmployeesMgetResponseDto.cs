...
// ************************************************************************
// <copyright file="Test_PostDirectoryV1EmployeesMgetResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量获取员工信息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostDirectoryV1EmployeesMgetResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Directory.PostDirectoryV1EmployeesMgetResponseDto>>(json);
