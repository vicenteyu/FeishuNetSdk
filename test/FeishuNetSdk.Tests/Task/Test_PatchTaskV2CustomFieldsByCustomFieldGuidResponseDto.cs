...
// ************************************************************************
// <copyright file="Test_PatchTaskV2CustomFieldsByCustomFieldGuidResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新自定义字段 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchTaskV2CustomFieldsByCustomFieldGuidResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Task.PatchTaskV2CustomFieldsByCustomFieldGuidResponseDto>>(json);
