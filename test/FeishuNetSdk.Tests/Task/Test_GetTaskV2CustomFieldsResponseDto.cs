...
// ************************************************************************
// <copyright file="Test_GetTaskV2CustomFieldsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 列取自定义字段 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetTaskV2CustomFieldsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Task.GetTaskV2CustomFieldsResponseDto>>(json);
