...
// ************************************************************************
// <copyright file="Test_GetTaskV2TasksByTaskGuidResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取任务详情 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetTaskV2TasksByTaskGuidResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Task.GetTaskV2TasksByTaskGuidResponseDto>>(json);
