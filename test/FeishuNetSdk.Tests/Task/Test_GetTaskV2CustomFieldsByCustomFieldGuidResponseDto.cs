...
// ************************************************************************
// <copyright file="Test_GetTaskV2CustomFieldsByCustomFieldGuidResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取自定义字段 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetTaskV2CustomFieldsByCustomFieldGuidResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Task.GetTaskV2CustomFieldsByCustomFieldGuidResponseDto>>(json);
