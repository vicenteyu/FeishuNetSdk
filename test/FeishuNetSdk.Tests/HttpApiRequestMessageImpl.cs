...
namespace FeishuNetSdk.Tests
{
    ...
    sealed class HttpApiRequestMessageImpl : HttpApiRequestMessage
    {
        ...
        /// 请求头的默认UserAgent
        /// </summary>
        private readonly static ProductInfoHeaderValue defaultUserAgent
            = new(assemblyName.Name ?? throw new ArgumentNullException(assemblyName.Name),
        ...
        private void EnsureMediaTypeEqual(string newMediaType)
        {
            ...
            var message = string.Format(Resx.contenType_RemainAs, oldMediaType);
