...
// ************************************************************************
// <copyright file="Test_DriveFilePermissionMemberAppliedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 文件协作者权限申请 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_DriveFilePermissionMemberAppliedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Ccm.Events.DriveFilePermissionMemberAppliedV1EventBodyDto>>(json);
