...
// ************************************************************************
// <copyright file="Test_PatchSearchV2SchemasBySchemaIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改数据范式 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchSearchV2SchemasBySchemaIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Search.Spec.PatchSearchV2SchemasBySchemaIdResponseDto>>(json);
