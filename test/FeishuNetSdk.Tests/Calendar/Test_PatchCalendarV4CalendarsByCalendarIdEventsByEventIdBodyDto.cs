...
// ************************************************************************
// <copyright file="Test_PatchCalendarV4CalendarsByCalendarIdEventsByEventIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新日程 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCalendarV4CalendarsByCalendarIdEventsByEventIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Calendar.PatchCalendarV4CalendarsByCalendarIdEventsByEventIdBodyDto>(json);
