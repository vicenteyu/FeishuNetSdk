...
// ************************************************************************
// <copyright file="Test_PostAilyV1SessionsByAilySessionIdRunsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建运行 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAilyV1SessionsByAilySessionIdRunsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Aily.PostAilyV1SessionsByAilySessionIdRunsResponseDto>>(json);
