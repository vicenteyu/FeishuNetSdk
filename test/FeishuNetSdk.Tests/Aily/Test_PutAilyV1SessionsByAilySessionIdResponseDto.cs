...
// ************************************************************************
// <copyright file="Test_PutAilyV1SessionsByAilySessionIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新会话 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutAilyV1SessionsByAilySessionIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Aily.PutAilyV1SessionsByAilySessionIdResponseDto>>(json);
