...
// ************************************************************************
// <copyright file="Test_GetAilyV1SessionsByAilySessionIdMessagesByAilyMessageIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取智能伙伴消息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetAilyV1SessionsByAilySessionIdMessagesByAilyMessageIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Aily.GetAilyV1SessionsByAilySessionIdMessagesByAilyMessageIdResponseDto>>(json);
