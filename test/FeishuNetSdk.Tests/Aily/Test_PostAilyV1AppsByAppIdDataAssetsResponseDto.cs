...
// ************************************************************************
// <copyright file="Test_PostAilyV1AppsByAppIdDataAssetsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建数据知识 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAilyV1AppsByAppIdDataAssetsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Aily.PostAilyV1AppsByAppIdDataAssetsResponseDto>>(json);
