...
// ************************************************************************
// <copyright file="Test_DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除数据知识 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Aily.DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto>>(json);
