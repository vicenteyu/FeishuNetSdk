...
// ************************************************************************
// <copyright file="Test_PostAdminV1BadgesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建勋章 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAdminV1BadgesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Admin.PostAdminV1BadgesBodyDto>(json);
