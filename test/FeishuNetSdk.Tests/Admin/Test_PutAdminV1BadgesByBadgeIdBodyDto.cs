...
// ************************************************************************
// <copyright file="Test_PutAdminV1BadgesByBadgeIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改勋章信息 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutAdminV1BadgesByBadgeIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Admin.PutAdminV1BadgesByBadgeIdBodyDto>(json);
