...
// ************************************************************************
// <copyright file="Test_PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改授予名单 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Admin.PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto>>(json);
