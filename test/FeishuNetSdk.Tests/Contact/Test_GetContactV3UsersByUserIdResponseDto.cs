...
// ************************************************************************
// <copyright file="Test_GetContactV3UsersByUserIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取单个用户信息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetContactV3UsersByUserIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Contact.GetContactV3UsersByUserIdResponseDto>>(json);
