...
// ************************************************************************
// <copyright file="Test_PostContactV3UnitBindDepartmentBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 建立部门与单位的绑定关系 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostContactV3UnitBindDepartmentBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Contact.PostContactV3UnitBindDepartmentBodyDto>(json);
