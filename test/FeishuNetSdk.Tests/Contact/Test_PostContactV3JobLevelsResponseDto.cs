...
// ************************************************************************
// <copyright file="Test_PostContactV3JobLevelsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建职级 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostContactV3JobLevelsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Contact.PostContactV3JobLevelsResponseDto>>(json);
