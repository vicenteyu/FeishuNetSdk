...
// ************************************************************************
// <copyright file="Test_GetContactV3UsersFindByDepartmentResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取部门直属用户列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetContactV3UsersFindByDepartmentResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Contact.GetContactV3UsersFindByDepartmentResponseDto>>(json);
