...
// ************************************************************************
// <copyright file="Test_GetContactV3JobLevelsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取租户职级列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetContactV3JobLevelsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Contact.GetContactV3JobLevelsResponseDto>>(json);
