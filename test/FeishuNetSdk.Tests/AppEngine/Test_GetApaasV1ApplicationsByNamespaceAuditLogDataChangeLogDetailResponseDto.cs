...
// ************************************************************************
// <copyright file="Test_GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogDetailResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询数据变更日志详情 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogDetailResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.AppEngine.GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogDetailResponseDto>>(json);
