...
// ************************************************************************
// <copyright file="Test_PostAttendanceV1UserApprovalsQueryResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取审批数据 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAttendanceV1UserApprovalsQueryResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.PostAttendanceV1UserApprovalsQueryResponseDto>>(json);
