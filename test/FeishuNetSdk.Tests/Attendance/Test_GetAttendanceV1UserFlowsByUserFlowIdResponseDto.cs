...
// ************************************************************************
// <copyright file="Test_GetAttendanceV1UserFlowsByUserFlowIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询打卡流水 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetAttendanceV1UserFlowsByUserFlowIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.GetAttendanceV1UserFlowsByUserFlowIdResponseDto>>(json);
