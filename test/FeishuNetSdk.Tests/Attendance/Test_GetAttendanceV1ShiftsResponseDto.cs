...
// ************************************************************************
// <copyright file="Test_GetAttendanceV1ShiftsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询所有班次 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetAttendanceV1ShiftsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.GetAttendanceV1ShiftsResponseDto>>(json);
