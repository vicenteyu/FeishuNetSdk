...
// ************************************************************************
// <copyright file="Test_PostAttendanceV1UserApprovalsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 写入审批结果 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAttendanceV1UserApprovalsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Attendance.PostAttendanceV1UserApprovalsBodyDto>(json);
