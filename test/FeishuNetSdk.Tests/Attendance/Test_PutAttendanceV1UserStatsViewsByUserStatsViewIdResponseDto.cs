...
// ************************************************************************
// <copyright file="Test_PutAttendanceV1UserStatsViewsByUserStatsViewIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新统计设置 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutAttendanceV1UserStatsViewsByUserStatsViewIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.PutAttendanceV1UserStatsViewsByUserStatsViewIdResponseDto>>(json);
