...
// ************************************************************************
// <copyright file="Test_PostAttendanceV1GroupsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建或修改考勤组 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAttendanceV1GroupsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.PostAttendanceV1GroupsResponseDto>>(json);
