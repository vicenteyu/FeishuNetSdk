...
/// </summary>
[TestClass]
public class Test_PostAttendanceV1ShiftsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.PostAttendanceV1ShiftsResponseDto>>(json);
