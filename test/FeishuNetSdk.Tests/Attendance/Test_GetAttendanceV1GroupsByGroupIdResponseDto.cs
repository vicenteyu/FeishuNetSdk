...
//     MIT
// </copyright>
// <summary>测试 按 ID 查询考勤组 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetAttendanceV1GroupsByGroupIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.GetAttendanceV1GroupsByGroupIdResponseDto>>(json);
