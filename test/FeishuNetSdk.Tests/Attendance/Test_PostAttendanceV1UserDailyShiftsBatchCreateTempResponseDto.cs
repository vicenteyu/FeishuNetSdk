...
// ************************************************************************
// <copyright file="Test_PostAttendanceV1UserDailyShiftsBatchCreateTempResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建或修改临时排班 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostAttendanceV1UserDailyShiftsBatchCreateTempResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Attendance.PostAttendanceV1UserDailyShiftsBatchCreateTempResponseDto>>(json);
