...
// ************************************************************************
// <copyright file="Test_PostMailV1UserMailboxesByUserMailboxIdDraftsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PostMailV1UserMailboxesByUserMailboxIdDraftsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Mail.PostMailV1UserMailboxesByUserMailboxIdDraftsBodyDto>(json);
