...
/// </summary>
[TestClass]
public class Test_PostMailV1UserMailboxesByUserMailboxIdMailContactsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Mail.PostMailV1UserMailboxesByUserMailboxIdMailContactsResponseDto>>(json);
