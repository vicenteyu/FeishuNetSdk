...
/// </summary>
[TestClass]
public class Test_GetMailV1UserMailboxesByUserMailboxIdDraftsByDraftIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Mail.GetMailV1UserMailboxesByUserMailboxIdDraftsByDraftIdResponseDto>>(json);
