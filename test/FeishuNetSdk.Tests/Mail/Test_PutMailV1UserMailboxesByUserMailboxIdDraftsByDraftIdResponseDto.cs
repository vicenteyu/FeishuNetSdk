...
// ************************************************************************
// <copyright file="Test_PutMailV1UserMailboxesByUserMailboxIdDraftsByDraftIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新草稿 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutMailV1UserMailboxesByUserMailboxIdDraftsByDraftIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Mail.PutMailV1UserMailboxesByUserMailboxIdDraftsByDraftIdResponseDto>>(json);
