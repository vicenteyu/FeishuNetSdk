...
// ************************************************************************
// <copyright file="Test_PutMailV1UserMailboxesByUserMailboxIdTemplatesByTemplateIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新邮件模板 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutMailV1UserMailboxesByUserMailboxIdTemplatesByTemplateIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Mail.PutMailV1UserMailboxesByUserMailboxIdTemplatesByTemplateIdResponseDto>>(json);
