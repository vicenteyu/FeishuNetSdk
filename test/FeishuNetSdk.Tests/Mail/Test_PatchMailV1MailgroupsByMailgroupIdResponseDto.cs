...
// ************************************************************************
// <copyright file="Test_PatchMailV1MailgroupsByMailgroupIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改邮件组部分信息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchMailV1MailgroupsByMailgroupIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Mail.PatchMailV1MailgroupsByMailgroupIdResponseDto>>(json);
