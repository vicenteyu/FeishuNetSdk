...
// ************************************************************************
// <copyright file="Test_PostImV1ChatsByChatIdManagersAddManagersResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 指定群管理员 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostImV1ChatsByChatIdManagersAddManagersResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.PostImV1ChatsByChatIdManagersAddManagersResponseDto>>(json);
