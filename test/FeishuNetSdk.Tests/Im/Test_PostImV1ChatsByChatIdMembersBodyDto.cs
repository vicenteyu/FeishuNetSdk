...
// ************************************************************************
// <copyright file="Test_PostImV1ChatsByChatIdMembersBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 将用户或机器人拉入群聊 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostImV1ChatsByChatIdMembersBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Im.PostImV1ChatsByChatIdMembersBodyDto>(json);
