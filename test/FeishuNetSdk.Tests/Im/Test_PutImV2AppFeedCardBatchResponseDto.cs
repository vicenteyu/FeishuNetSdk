...
// ************************************************************************
// <copyright file="Test_PutImV2AppFeedCardBatchResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新应用消息流卡片 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutImV2AppFeedCardBatchResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.PutImV2AppFeedCardBatchResponseDto>>(json);
