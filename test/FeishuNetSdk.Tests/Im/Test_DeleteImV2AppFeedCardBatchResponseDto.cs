...
// ************************************************************************
// <copyright file="Test_DeleteImV2AppFeedCardBatchResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除应用消息流卡片 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_DeleteImV2AppFeedCardBatchResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.DeleteImV2AppFeedCardBatchResponseDto>>(json);
