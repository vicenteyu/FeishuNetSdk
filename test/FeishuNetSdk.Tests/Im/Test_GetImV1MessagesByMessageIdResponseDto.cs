...
/// </summary>
[TestClass]
public class Test_GetImV1MessagesByMessageIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.GetImV1MessagesByMessageIdResponseDto>>(json);
