...
// ************************************************************************
// <copyright file="Test_PostImV1ChatsByChatIdMenuTreeBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 添加群菜单 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostImV1ChatsByChatIdMenuTreeBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Im.PostImV1ChatsByChatIdMenuTreeBodyDto>(json);
