...
// ************************************************************************
// <copyright file="Test_PatchImV1ChatsByChatIdMenuItemsByMenuItemIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改群菜单元信息 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchImV1ChatsByChatIdMenuItemsByMenuItemIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Im.PatchImV1ChatsByChatIdMenuItemsByMenuItemIdBodyDto>(json);
