...
// ************************************************************************
// <copyright file="Test_GetImV1ChatsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取用户或机器人所在的群列表 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Tests.Im;

/// <summary>
/// 测试 获取用户或机器人所在的群列表 响应体
...
/// </summary>
[TestClass]
public class Test_GetImV1ChatsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.GetImV1ChatsResponseDto>>(json);
