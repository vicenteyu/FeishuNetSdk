...
// ************************************************************************
// <copyright file="Test_PatchImV1MessagesByMessageIdUrgentPhoneBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 发送电话加急 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchImV1MessagesByMessageIdUrgentPhoneBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Im.PatchImV1MessagesByMessageIdUrgentPhoneBodyDto>(json);
