...
// ************************************************************************
// <copyright file="Test_GetImV1ChatsByChatIdMenuTreeResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取群菜单 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetImV1ChatsByChatIdMenuTreeResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.GetImV1ChatsByChatIdMenuTreeResponseDto>>(json);
