...
// ************************************************************************
// <copyright file="Test_PostImV1ChatsByChatIdMenuTreeSortResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 排序群菜单 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostImV1ChatsByChatIdMenuTreeSortResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Im.PostImV1ChatsByChatIdMenuTreeSortResponseDto>>(json);
