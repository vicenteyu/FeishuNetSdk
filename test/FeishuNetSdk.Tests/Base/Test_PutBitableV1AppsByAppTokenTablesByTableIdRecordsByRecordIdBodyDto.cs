...
// ************************************************************************
// <copyright file="Test_PutBitableV1AppsByAppTokenTablesByTableIdRecordsByRecordIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新记录 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutBitableV1AppsByAppTokenTablesByTableIdRecordsByRecordIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Base.PutBitableV1AppsByAppTokenTablesByTableIdRecordsByRecordIdBodyDto>(json);
