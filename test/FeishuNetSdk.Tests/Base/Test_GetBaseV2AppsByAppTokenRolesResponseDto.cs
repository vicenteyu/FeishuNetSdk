...
// ************************************************************************
// <copyright file="Test_GetBaseV2AppsByAppTokenRolesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 列出自定义角色 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetBaseV2AppsByAppTokenRolesResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Base.GetBaseV2AppsByAppTokenRolesResponseDto>>(json);
