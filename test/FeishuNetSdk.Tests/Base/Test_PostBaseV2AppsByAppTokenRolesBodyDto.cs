...
// ************************************************************************
// <copyright file="Test_PostBaseV2AppsByAppTokenRolesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 新增自定义角色 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostBaseV2AppsByAppTokenRolesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Base.PostBaseV2AppsByAppTokenRolesBodyDto>(json);
