...
// ************************************************************************
// <copyright file="Test_PutBitableV1AppsByAppTokenRolesByRoleIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PutBitableV1AppsByAppTokenRolesByRoleIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Base.PutBitableV1AppsByAppTokenRolesByRoleIdBodyDto>(json);
