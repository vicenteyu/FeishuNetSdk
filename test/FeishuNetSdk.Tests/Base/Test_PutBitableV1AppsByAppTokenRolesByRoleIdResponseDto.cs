...
// ************************************************************************
// <copyright file="Test_PutBitableV1AppsByAppTokenRolesByRoleIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新自定义角色 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutBitableV1AppsByAppTokenRolesByRoleIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Base.PutBitableV1AppsByAppTokenRolesByRoleIdResponseDto>>(json);
