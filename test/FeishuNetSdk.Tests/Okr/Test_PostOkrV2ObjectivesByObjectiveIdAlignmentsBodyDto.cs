...
// ************************************************************************
// <copyright file="Test_PostOkrV2ObjectivesByObjectiveIdAlignmentsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建目标对齐关系 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostOkrV2ObjectivesByObjectiveIdAlignmentsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Okr.PostOkrV2ObjectivesByObjectiveIdAlignmentsBodyDto>(json);
