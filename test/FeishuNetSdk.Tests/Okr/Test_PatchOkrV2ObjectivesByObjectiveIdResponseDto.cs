...
// ************************************************************************
// <copyright file="Test_PatchOkrV2ObjectivesByObjectiveIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 编辑 OKR 目标 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchOkrV2ObjectivesByObjectiveIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Okr.PatchOkrV2ObjectivesByObjectiveIdResponseDto>>(json);
