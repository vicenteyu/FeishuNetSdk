...
// ************************************************************************
// <copyright file="Test_PostOkrV2ObjectivesByObjectiveIdKeyResultsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 在目标下创建关键结果 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostOkrV2ObjectivesByObjectiveIdKeyResultsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Okr.PostOkrV2ObjectivesByObjectiveIdKeyResultsBodyDto>(json);
