...
// ************************************************************************
// <copyright file="Test_PutOkrV2CyclesByCycleIdObjectivesWeightBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改 OKR 目标权重 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PutOkrV2CyclesByCycleIdObjectivesWeightBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Okr.PutOkrV2CyclesByCycleIdObjectivesWeightBodyDto>(json);
