...
// ************************************************************************
// <copyright file="Test_PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改系统状态 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.PersonalSettings.PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDto>>(json);
