...
// ************************************************************************
// <copyright file="Test_PostPersonalSettingsV1SystemStatusesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建系统状态 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostPersonalSettingsV1SystemStatusesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.PersonalSettings.PostPersonalSettingsV1SystemStatusesBodyDto>(json);
