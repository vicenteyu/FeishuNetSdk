...
// ************************************************************************
// <copyright file="Test_CorehrJobChangeUpdatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 异动状态变更（不推荐） 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrJobChangeUpdatedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.FeishuPeople.Events.CorehrJobChangeUpdatedV1EventBodyDto>>(json);
