...
// ************************************************************************
// <copyright file="Test_CorehrDepartmentDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除部门 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrDepartmentDeletedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.FeishuPeople.Events.CorehrDepartmentDeletedV1EventBodyDto>>(json);
