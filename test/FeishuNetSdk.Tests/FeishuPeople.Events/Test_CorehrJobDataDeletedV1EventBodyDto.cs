...
// ************************************************************************
// <copyright file="Test_CorehrJobDataDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 任职信息删除 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrJobDataDeletedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.FeishuPeople.Events.CorehrJobDataDeletedV1EventBodyDto>>(json);
