...
// ************************************************************************
// <copyright file="Test_CorehrEmploymentDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 【事件】删除雇佣信息 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CorehrEmploymentDeletedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.FeishuPeople.Events.CorehrEmploymentDeletedV1EventBodyDto>>(json);
