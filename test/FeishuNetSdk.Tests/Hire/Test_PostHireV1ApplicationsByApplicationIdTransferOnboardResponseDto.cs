...
// ************************************************************************
// <copyright file="Test_PostHireV1ApplicationsByApplicationIdTransferOnboardResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 操作候选人入职 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1ApplicationsByApplicationIdTransferOnboardResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Hire.PostHireV1ApplicationsByApplicationIdTransferOnboardResponseDto>>(json);
