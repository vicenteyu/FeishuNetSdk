...
// ************************************************************************
// <copyright file="Test_PostHireV1JobRequirementsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建招聘需求 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1JobRequirementsBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Hire.PostHireV1JobRequirementsBodyDto>(json);
