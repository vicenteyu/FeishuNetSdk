...
// ************************************************************************
// <copyright file="Test_PostHireV1TalentsCombinedCreateBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建人才 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1TalentsCombinedCreateBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Hire.PostHireV1TalentsCombinedCreateBodyDto>(json);
