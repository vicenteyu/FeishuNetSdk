...
// ************************************************************************
// <copyright file="Test_PostHireV1OffersBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建 Offer 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1OffersBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Hire.PostHireV1OffersBodyDto>(json);
