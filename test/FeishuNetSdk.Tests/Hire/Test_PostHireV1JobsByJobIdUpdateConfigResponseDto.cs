...
// ************************************************************************
// <copyright file="Test_PostHireV1JobsByJobIdUpdateConfigResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新职位设置 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1JobsByJobIdUpdateConfigResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Hire.PostHireV1JobsByJobIdUpdateConfigResponseDto>>(json);
