...
// ************************************************************************
// <copyright file="Test_PostHireV1TalentsRemoveToFolderBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 将人才从指定文件夹移除 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1TalentsRemoveToFolderBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Hire.PostHireV1TalentsRemoveToFolderBodyDto>(json);
