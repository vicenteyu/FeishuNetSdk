...
// ************************************************************************
// <copyright file="Test_GetHireV1ReferralWebsitesJobPostsByJobPostIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取内推官网下职位广告详情 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Tests.Hire;

/// <summary>
/// 测试 获取内推官网下职位广告详情 响应体
...
/// </summary>
[TestClass]
public class Test_GetHireV1ReferralWebsitesJobPostsByJobPostIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Hire.GetHireV1ReferralWebsitesJobPostsByJobPostIdResponseDto>>(json);
