...
// ************************************************************************
// <copyright file="Test_PostHireV1TalentsAddToFolderBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 将人才加入指定文件夹 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostHireV1TalentsAddToFolderBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Hire.PostHireV1TalentsAddToFolderBodyDto>(json);
