...
// ************************************************************************
// <copyright file="Test_GetHireV1OffersByOfferIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取 Offer 详情 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetHireV1OffersByOfferIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Hire.GetHireV1OffersByOfferIdResponseDto>>(json);
