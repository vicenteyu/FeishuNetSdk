...
// ************************************************************************
// <copyright file="Test_CalendarCalendarAclDeletedV4EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 删除 ACL 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_CalendarCalendarAclDeletedV4EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Calendar.Events.CalendarCalendarAclDeletedV4EventBodyDto>>(json);
