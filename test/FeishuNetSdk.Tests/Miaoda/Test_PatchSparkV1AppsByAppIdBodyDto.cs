...
// ************************************************************************
// <copyright file="Test_PatchSparkV1AppsByAppIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新妙搭应用信息 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchSparkV1AppsByAppIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Miaoda.PatchSparkV1AppsByAppIdBodyDto>(json);
