...
// ************************************************************************
// <copyright file="Test_PostSparkV1AppsByAppIdSqlCommandsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 执行 SQL 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostSparkV1AppsByAppIdSqlCommandsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Miaoda.PostSparkV1AppsByAppIdSqlCommandsResponseDto>>(json);
