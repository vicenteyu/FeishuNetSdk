...
// ************************************************************************
// <copyright file="Test_VcRoomCreatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 创建会议室 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_VcRoomCreatedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Vc.Events.VcRoomCreatedV1EventBodyDto>>(json);
