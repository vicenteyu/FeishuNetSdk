...
// ************************************************************************
// <copyright file="Test_VcMeetingLeaveMeetingV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 离开会议 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_VcMeetingLeaveMeetingV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Vc.Events.VcMeetingLeaveMeetingV1EventBodyDto>>(json);
