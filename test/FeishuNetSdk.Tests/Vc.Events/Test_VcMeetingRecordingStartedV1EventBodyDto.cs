...
// ************************************************************************
// <copyright file="Test_VcMeetingRecordingStartedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 开始录制 事件体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_VcMeetingRecordingStartedV1EventBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<EventV2Dto<FeishuNetSdk.Vc.Events.VcMeetingRecordingStartedV1EventBodyDto>>(json);
