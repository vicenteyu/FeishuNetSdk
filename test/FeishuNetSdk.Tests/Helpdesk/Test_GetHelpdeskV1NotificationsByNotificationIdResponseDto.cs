...
// ************************************************************************
// <copyright file="Test_GetHelpdeskV1NotificationsByNotificationIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询推送 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetHelpdeskV1NotificationsByNotificationIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Helpdesk.GetHelpdeskV1NotificationsByNotificationIdResponseDto>>(json);
