...
// ************************************************************************
// <copyright file="Test_PostVcV1NotesSubscriptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 订阅纪要变更事件 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostVcV1NotesSubscriptionBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Vc.PostVcV1NotesSubscriptionBodyDto>(json);
