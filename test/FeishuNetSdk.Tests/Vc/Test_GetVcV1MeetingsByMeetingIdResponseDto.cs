...
// ************************************************************************
// <copyright file="Test_GetVcV1MeetingsByMeetingIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取会议详情 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetVcV1MeetingsByMeetingIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Vc.GetVcV1MeetingsByMeetingIdResponseDto>>(json);
