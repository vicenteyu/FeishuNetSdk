...
/// </summary>
[TestClass]
public class Test_GetCorehrV1JobFamiliesByJobFamilyIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.GetCorehrV1JobFamiliesByJobFamilyIdResponseDto>>(json);
