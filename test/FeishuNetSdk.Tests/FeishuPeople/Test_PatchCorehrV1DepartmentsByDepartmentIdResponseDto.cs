...
// ************************************************************************
// <copyright file="Test_PatchCorehrV1DepartmentsByDepartmentIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新部门 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV1DepartmentsByDepartmentIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.PatchCorehrV1DepartmentsByDepartmentIdResponseDto>>(json);
