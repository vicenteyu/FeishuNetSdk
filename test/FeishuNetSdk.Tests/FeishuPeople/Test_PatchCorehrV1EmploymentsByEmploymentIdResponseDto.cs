...
// ************************************************************************
// <copyright file="Test_PatchCorehrV1EmploymentsByEmploymentIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新雇佣信息 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV1EmploymentsByEmploymentIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.PatchCorehrV1EmploymentsByEmploymentIdResponseDto>>(json);
