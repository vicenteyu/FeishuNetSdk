...
// ************************************************************************
// <copyright file="Test_GetCorehrV1CustomFieldsGetByParamResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 获取字段详情 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetCorehrV1CustomFieldsGetByParamResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.GetCorehrV1CustomFieldsGetByParamResponseDto>>(json);
