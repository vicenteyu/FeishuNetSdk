...
// ************************************************************************
// <copyright file="Test_PostCorehrV1PersonsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PostCorehrV1PersonsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.PostCorehrV1PersonsResponseDto>>(json);
