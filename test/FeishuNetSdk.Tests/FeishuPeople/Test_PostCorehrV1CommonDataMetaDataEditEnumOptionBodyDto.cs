...
// ************************************************************************
// <copyright file="Test_PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 修改字段枚举值选项 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.FeishuPeople.PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDto>(json);
