...
// ************************************************************************
// <copyright file="Test_PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新国家证件类型 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDto>>(json);
