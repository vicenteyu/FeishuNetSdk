...
// ************************************************************************
// <copyright file="Test_PatchCorehrV1PersonsByPersonIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新个人信息 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV1PersonsByPersonIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.FeishuPeople.PatchCorehrV1PersonsByPersonIdBodyDto>(json);
