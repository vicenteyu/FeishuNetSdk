...
// ************************************************************************
// <copyright file="Test_PostCorehrV1JobChangesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 发起员工异动(不推荐) 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV1JobChangesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.FeishuPeople.PostCorehrV1JobChangesBodyDto>(json);
