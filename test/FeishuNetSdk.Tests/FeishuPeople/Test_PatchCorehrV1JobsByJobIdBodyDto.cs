...
// ************************************************************************
// <copyright file="Test_PatchCorehrV1JobsByJobIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新职务 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV1JobsByJobIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.FeishuPeople.PatchCorehrV1JobsByJobIdBodyDto>(json);
