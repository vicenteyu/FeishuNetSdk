...
// ************************************************************************
// <copyright file="Test_PostCorehrV1JobChangesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 发起员工异动(不推荐) 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV1JobChangesResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.FeishuPeople.PostCorehrV1JobChangesResponseDto>>(json);
