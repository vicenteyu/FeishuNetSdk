...
// ************************************************************************
// <copyright file="Test_PostApprovalV4TasksSubscriptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 订阅审批任务状态变更事件 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostApprovalV4TasksSubscriptionBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Approval.PostApprovalV4TasksSubscriptionBodyDto>(json);
