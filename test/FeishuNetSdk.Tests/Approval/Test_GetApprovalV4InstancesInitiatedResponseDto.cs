...
// ************************************************************************
// <copyright file="Test_GetApprovalV4InstancesInitiatedResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询用户的已发起审批列表 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_GetApprovalV4InstancesInitiatedResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Approval.GetApprovalV4InstancesInitiatedResponseDto>>(json);
