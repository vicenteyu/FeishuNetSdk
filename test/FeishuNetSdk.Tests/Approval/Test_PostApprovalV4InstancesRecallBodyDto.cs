...
// ************************************************************************
// <copyright file="Test_PostApprovalV4InstancesRecallBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 撤回审批实例（用户级） 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostApprovalV4InstancesRecallBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Approval.PostApprovalV4InstancesRecallBodyDto>(json);
