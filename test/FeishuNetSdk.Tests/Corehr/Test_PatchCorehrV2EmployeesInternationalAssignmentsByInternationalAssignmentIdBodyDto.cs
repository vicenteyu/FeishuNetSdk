...
// ************************************************************************
// <copyright file="Test_PatchCorehrV2EmployeesInternationalAssignmentsByInternationalAssignmentIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新外派信息 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV2EmployeesInternationalAssignmentsByInternationalAssignmentIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PatchCorehrV2EmployeesInternationalAssignmentsByInternationalAssignmentIdBodyDto>(json);
