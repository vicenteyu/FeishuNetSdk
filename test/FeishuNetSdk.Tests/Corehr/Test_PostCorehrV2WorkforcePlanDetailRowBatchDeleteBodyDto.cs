...
// ************************************************************************
// <copyright file="Test_PostCorehrV2WorkforcePlanDetailRowBatchDeleteBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量删除明细行 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2WorkforcePlanDetailRowBatchDeleteBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2WorkforcePlanDetailRowBatchDeleteBodyDto>(json);
