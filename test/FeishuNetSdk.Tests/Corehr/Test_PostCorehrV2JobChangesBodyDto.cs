...
// ************************************************************************
// <copyright file="Test_PostCorehrV2JobChangesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 发起员工异动 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2JobChangesBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2JobChangesBodyDto>(json);
