...
// ************************************************************************
// <copyright file="Test_PatchCorehrV2LocationsByLocationIdAddressesByAddressIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 更新地点地址 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV2LocationsByLocationIdAddressesByAddressIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PatchCorehrV2LocationsByLocationIdAddressesByAddressIdBodyDto>(json);
