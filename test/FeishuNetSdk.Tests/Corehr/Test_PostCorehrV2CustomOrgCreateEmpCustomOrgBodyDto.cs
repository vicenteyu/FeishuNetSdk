...
// ************************************************************************
// <copyright file="Test_PostCorehrV2CustomOrgCreateEmpCustomOrgBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 新增人员自定义组织变更记录 请求体</summary>
// ************************************************************************
namespace FeishuNetSdk.Tests.Corehr;

/// <summary>
/// 测试 新增人员自定义组织变更记录 请求体
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2CustomOrgCreateEmpCustomOrgBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2CustomOrgCreateEmpCustomOrgBodyDto>(json);
