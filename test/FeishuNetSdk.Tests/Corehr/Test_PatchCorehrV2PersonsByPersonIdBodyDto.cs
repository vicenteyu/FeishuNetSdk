...
// ************************************************************************
// <copyright file="Test_PatchCorehrV2PersonsByPersonIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV2PersonsByPersonIdBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PatchCorehrV2PersonsByPersonIdBodyDto>(json);
