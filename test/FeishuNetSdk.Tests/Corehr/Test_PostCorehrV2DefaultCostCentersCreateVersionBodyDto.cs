...
// ************************************************************************
// <copyright file="Test_PostCorehrV2DefaultCostCentersCreateVersionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 添加默认成本中心 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2DefaultCostCentersCreateVersionBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2DefaultCostCentersCreateVersionBodyDto>(json);
