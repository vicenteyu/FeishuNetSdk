...
// ************************************************************************
// <copyright file="Test_PostCorehrV2PreHiresRestoreFlowInstanceBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 恢复入职 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2PreHiresRestoreFlowInstanceBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2PreHiresRestoreFlowInstanceBodyDto>(json);
