...
/// </summary>
[TestClass]
public class Test_GetCorehrV2JobsResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Corehr.GetCorehrV2JobsResponseDto>>(json);
