...
// ************************************************************************
// <copyright file="Test_GetCorehrV2CustomOrgEmploymentCustomOrgRecordResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 批量查询人员自定义组织变更记录 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Tests.Corehr;

/// <summary>
/// 测试 批量查询人员自定义组织变更记录 响应体
...
/// </summary>
[TestClass]
public class Test_GetCorehrV2CustomOrgEmploymentCustomOrgRecordResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Corehr.GetCorehrV2CustomOrgEmploymentCustomOrgRecordResponseDto>>(json);
