...
// ************************************************************************
// <copyright file="Test_PostCorehrV2BpsGetByDepartmentResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询部门 HRBP 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2BpsGetByDepartmentResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Corehr.PostCorehrV2BpsGetByDepartmentResponseDto>>(json);
