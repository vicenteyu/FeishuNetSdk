...
// ************************************************************************
// <copyright file="Test_PostCorehrV2JobFamiliesQueryMultiTimelineBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 查询指定时间范围序列版本 请求体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PostCorehrV2JobFamiliesQueryMultiTimelineBodyDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuNetSdk.Corehr.PostCorehrV2JobFamiliesQueryMultiTimelineBodyDto>(json);
