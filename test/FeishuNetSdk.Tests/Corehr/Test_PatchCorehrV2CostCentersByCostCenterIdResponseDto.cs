...
// ************************************************************************
// <copyright file="Test_PatchCorehrV2CostCentersByCostCenterIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>测试 启用 / 停用成本中心 响应体</summary>
// ************************************************************************
...
/// </summary>
[TestClass]
public class Test_PatchCorehrV2CostCentersByCostCenterIdResponseDto : TestBase
{
    [TestMethod]
    public void TestDto()
    {
...
""";
        var result = Deserialize<FeishuResponse<FeishuNetSdk.Corehr.PatchCorehrV2CostCentersByCostCenterIdResponseDto>>(json);
