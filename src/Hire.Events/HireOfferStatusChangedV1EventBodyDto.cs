...
/// <summary>
/// Offer 状态变更 事件体
/// <para>当 Offer 状态发生变更时发送该事件。Offer 创建时不会发送，Offer 状态变更场景可参考「Offer 状态流转图」。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=hire&amp;version=v1&amp;resource=offer&amp;event=status_changed)</para>
