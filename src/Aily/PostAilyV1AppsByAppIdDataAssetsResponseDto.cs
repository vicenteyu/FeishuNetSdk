...
// ************************************************************************
// <copyright file="PostAilyV1AppsByAppIdDataAssetsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建数据知识 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostAilyV1AppsByAppIdDataAssetsResponseDto
{
    /// <summary>
    /// <para>数据知识</para>
    /// <para>必填：否</para>
    ...
    public PostAilyV1AppsByAppIdDataAssetsResponseDtoDataAsset? DataAsset { get; set; }

    /// <summary>
    /// <para>数据知识</para>
    /// </summary>
    public record PostAilyV1AppsByAppIdDataAssetsResponseDtoDataAsset
    {
        /// <summary>
        /// <para>数据知识ID</para>
        /// <para>必填：否</para>
        ...
        /// <item>larkbiz_doc：旧版飞书云文档，目前已不支持</item>
        /// <item>larkbiz_docs：飞书docs</item>
        /// <item>larkbiz_docx：新版飞书云文档，当前创建的飞书云文档均为此类型</item>
        /// <item>larkbiz_pdf：云盘/wiki中的pdf文件pdf文件</item>
        /// <item>larkbiz_word：云盘/wiki中的.docx（Word）</item>
        /// <item>larkbiz_pptx：云盘/wiki中的.pptx（Powerpoint）</item>
