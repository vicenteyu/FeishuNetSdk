...
// ************************************************************************
// <copyright file="GetAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取数据知识 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto
{
    /// <summary>
    /// <para>数据知识</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("data_asset")]
    public GetAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDtoDataAsset? DataAsset { get; set; }

    /// <summary>
    /// <para>数据知识</para>
    /// </summary>
    public record GetAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDtoDataAsset
    {
        /// <summary>
        /// <para>数据知识ID</para>
        /// <para>必填：否</para>
        ...
        /// <para>数据知识描述</para>
        /// <para>必填：否</para>
        /// <para>示例值：{"zh_ch":"这是一篇关于电影评价的文章"}</para>
        /// </summary>
        ...
        /// <item>larkbiz_doc：旧版飞书云文档，不支持</item>
        /// <item>larkbiz_docs：飞书docs</item>
        /// <item>larkbiz_docx：新版飞书云文档，目前线上新创建的云文档均属于此类型</item>
        /// <item>larkbiz_pdf：云盘/wiki中的pdf</item>
        /// <item>larkbiz_word：云盘/wiki中的.docx（Word文档）</item>
        /// <item>larkbiz_pptx：云盘/wiki中的.pptx（Powerpoint），不包括飞书幻灯片</item>
        /// <item>larkbiz_sheets：飞书电子表格</item>
