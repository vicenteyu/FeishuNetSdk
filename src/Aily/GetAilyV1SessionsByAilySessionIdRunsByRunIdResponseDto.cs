...
// ************************************************************************
// <copyright file="GetAilyV1SessionsByAilySessionIdRunsByRunIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取运行 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetAilyV1SessionsByAilySessionIdRunsByRunIdResponseDto
{
    /// <summary>
    /// <para>运行信息</para>
    /// <para>必填：否</para>
    ...
    public GetAilyV1SessionsByAilySessionIdRunsByRunIdResponseDtoRun? Run { get; set; }

    /// <summary>
    /// <para>运行信息</para>
    /// </summary>
    public record GetAilyV1SessionsByAilySessionIdRunsByRunIdResponseDtoRun
    {
        /// <summary>
        /// <para>运行 ID</para>
        /// <para>必填：是</para>
