...
// ************************************************************************
// <copyright file="DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>删除数据知识 响应体</summary>
// ************************************************************************
...
/// </summary>
public record DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDto
{
    /// <summary>
    /// <para>数据知识</para>
    /// <para>必填：否</para>
    ...
    public DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDtoDataAsset? DataAsset { get; set; }

    /// <summary>
    /// <para>数据知识</para>
    /// </summary>
    public record DeleteAilyV1AppsByAppIdDataAssetsByDataAssetIdResponseDtoDataAsset
    {
        /// <summary>
        /// <para>数据知识ID</para>
        /// <para>必填：否</para>
