...
// ************************************************************************
// <copyright file="PostAilyV1AgentsByAgentIdAgentVisibilityCheckBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取当前用户的可见性 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostAilyV1AgentsByAgentIdAgentVisibilityCheckBodyDto
{
    /// <summary>
    /// <para>渠道类型</para>
    /// <para>- 可选值为web_sdk</para>
    /// <para>必填：是</para>
    /// <para>示例值：web_sdk</para>
    /// <para>最大长度：64</para>
    /// <para>最小长度：0</para>
    /// </summary>
