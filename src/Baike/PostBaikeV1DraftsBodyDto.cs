...
// ************************************************************************
// <copyright file="PostBaikeV1DraftsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
public record PostBaikeV1DraftsBodyDto
{
    /// <summary>
    ...
    public PostBaikeV1DraftsBodyDtoRelatedMeta? RelatedMeta { get; set; }

    /// <summary>
    /// <para>更多相关信息</para>
    /// </summary>
    public record PostBaikeV1DraftsBodyDtoRelatedMeta
    {
        /// <summary>
        /// <para>相关联系人</para>
        /// <para>必填：否</para>
    ...
    public PostBaikeV1DraftsBodyDtoOuterInfo? OuterInfo { get; set; }

    /// <summary>
    /// <para>外部系统关联数据</para>
    /// </summary>
    public record PostBaikeV1DraftsBodyDtoOuterInfo
    {
        /// <summary>
