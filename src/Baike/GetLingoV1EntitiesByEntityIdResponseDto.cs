...
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/get</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2flingo-v1%2fentity%2fget</para>
/// </summary>
public record GetLingoV1EntitiesByEntityIdResponseDto
{
    /// <summary>
    /// <para>词条</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonProperty("entity")]
    public GetLingoV1EntitiesByEntityIdResponseDtoEntity? Entity { get; set; }

    /// <summary>
    /// <para>词条</para>
    /// </summary>
    public record GetLingoV1EntitiesByEntityIdResponseDtoEntity
    {
        /// <summary>
        ...
        public GetLingoV1EntitiesByEntityIdResponseDtoEntityRelatedMeta? RelatedMeta { get; set; }

        /// <summary>
        /// <para>更多相关信息</para>
        /// </summary>
        public record GetLingoV1EntitiesByEntityIdResponseDtoEntityRelatedMeta
        {
            /// <summary>
            /// <para>相关联系人</para>
            /// <para>必填：否</para>
            ...
            {
                /// <summary>
                /// <para>通过文件接口上通过文件接口上传图片后，获得的图片 token后的图片 token</para>
                /// <para>必填：是</para>
        ...
        public GetLingoV1EntitiesByEntityIdResponseDtoEntityStatistics? Statistics { get; set; }

        /// <summary>
        /// <para>当前词条收到的反馈数据</para>
        /// </summary>
        public record GetLingoV1EntitiesByEntityIdResponseDtoEntityStatistics
        {
            /// <summary>
            /// <para>累计点赞</para>
            /// <para>必填：是</para>
        ...
        public GetLingoV1EntitiesByEntityIdResponseDtoEntityOuterInfo? OuterInfo { get; set; }

        /// <summary>
        /// <para>外部系统关联数据</para>
        /// </summary>
        public record GetLingoV1EntitiesByEntityIdResponseDtoEntityOuterInfo
        {
            /// <summary>
        ...
        /// <para>必填：否</para>
        /// <para>示例值：&lt;b&gt;加粗&lt;/b&gt;&lt;i&gt;斜体&lt;/i&gt;&lt;p&gt;&lt;ahref="https://feishu.cn"&gt;l链接&lt;/a&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;企业百科是飞书提供的一款知识管理工具，通过企业百科可以帮助企业将分散的知识信息进行聚合，并通过UGC的方式，促进企业知识的保鲜和流通&lt;/span&gt;&lt;/p&gt;</para>
        /// <para>最大长度：5000</para>
        /// </summary>
