...
// ************************************************************************
// <copyright file="PutLingoV1DraftsByDraftIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新草稿 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PutLingoV1DraftsByDraftIdResponseDto
{
    /// <summary>
    /// <para>草稿</para>
    /// <para>必填：否</para>
    ...
    public PutLingoV1DraftsByDraftIdResponseDtoDraft? Draft { get; set; }

    /// <summary>
    /// <para>草稿</para>
    /// </summary>
    public record PutLingoV1DraftsByDraftIdResponseDtoDraft
    {
        /// <summary>
        /// <para>草稿 Id</para>
        /// <para>必填：否</para>
        ...
        public PutLingoV1DraftsByDraftIdResponseDtoDraftEntity? Entity { get; set; }

        /// <summary>
        /// <para>实体词</para>
        /// </summary>
        public record PutLingoV1DraftsByDraftIdResponseDtoDraftEntity
        {
            /// <summary>
            ...
            public PutLingoV1DraftsByDraftIdResponseDtoDraftEntityRelatedMeta? RelatedMeta { get; set; }

            /// <summary>
            /// <para>相关数据</para>
            /// </summary>
            public record PutLingoV1DraftsByDraftIdResponseDtoDraftEntityRelatedMeta
            {
                /// <summary>
                /// <para>关联用户信息</para>
                /// <para>必填：否</para>
            ...
            public PutLingoV1DraftsByDraftIdResponseDtoDraftEntityStatistics? Statistics { get; set; }

            /// <summary>
            /// <para>当前词条收到的反馈数据</para>
            /// </summary>
            public record PutLingoV1DraftsByDraftIdResponseDtoDraftEntityStatistics
            {
                /// <summary>
                /// <para>点赞数量</para>
                /// <para>必填：是</para>
            ...
            public PutLingoV1DraftsByDraftIdResponseDtoDraftEntityOuterInfo? OuterInfo { get; set; }

            /// <summary>
            /// <para>外部系统关联数据</para>
            /// </summary>
            public record PutLingoV1DraftsByDraftIdResponseDtoDraftEntityOuterInfo
            {
                /// <summary>
