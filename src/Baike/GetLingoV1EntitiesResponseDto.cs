...
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/lingo-v1/entity/list</para>
...
/// </summary>
public record GetLingoV1EntitiesResponseDto
{
    /// <summary>
    /// <para>词条列表</para>
    /// <para>必填：否</para>
    ...
    public record Entity
    {
        ...
        /// <para>必填：否</para>
        /// <para>示例值：&lt;b&gt;加粗&lt;/b&gt;&lt;i&gt;斜体&lt;/i&gt;&lt;p&gt;&lt;ahref="https://feishu.cn"&gt;l链接&lt;/a&gt;&lt;/p&gt;&lt;p&gt;&lt;span&gt;飞书词典是飞书提供的一款知识管理工具，通过词典可以帮助企业将分散的知识信息进行聚合，并通过UGC的方式，促进企业知识的保鲜和流通&lt;/span&gt;&lt;/p&gt;</para>
        /// <para>最大长度：5000</para>
        /// </summary>
