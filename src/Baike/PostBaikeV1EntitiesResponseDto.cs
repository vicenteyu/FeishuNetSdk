...
// ************************************************************************
// <copyright file="PostBaikeV1EntitiesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建免审词条 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostBaikeV1EntitiesResponseDto
{
    /// <summary>
    /// <para>词条信息</para>
    /// <para>必填：否</para>
    ...
    public PostBaikeV1EntitiesResponseDtoEntity? Entity { get; set; }

    /// <summary>
    /// <para>词条信息</para>
    /// </summary>
    public record PostBaikeV1EntitiesResponseDtoEntity
    {
        /// <summary>
        ...
        public PostBaikeV1EntitiesResponseDtoEntityRelatedMeta? RelatedMeta { get; set; }

        /// <summary>
        /// <para>更多相关信息</para>
        /// </summary>
        public record PostBaikeV1EntitiesResponseDtoEntityRelatedMeta
        {
            /// <summary>
            /// <para>相关联系人</para>
            /// <para>必填：否</para>
        ...
        public PostBaikeV1EntitiesResponseDtoEntityStatistics? Statistics { get; set; }

        /// <summary>
        /// <para>当前词条收到的反馈数据</para>
        /// </summary>
        public record PostBaikeV1EntitiesResponseDtoEntityStatistics
        {
            /// <summary>
            /// <para>累计点赞</para>
            /// <para>必填：是</para>
        ...
        public PostBaikeV1EntitiesResponseDtoEntityOuterInfo? OuterInfo { get; set; }

        /// <summary>
        /// <para>外部系统关联数据</para>
        /// </summary>
        public record PostBaikeV1EntitiesResponseDtoEntityOuterInfo
        {
            /// <summary>
