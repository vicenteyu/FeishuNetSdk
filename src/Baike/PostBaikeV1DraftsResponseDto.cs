...
/// </summary>
public record PostBaikeV1DraftsResponseDto
{
    /// <summary>
    /// <para>草稿信息</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonProperty("draft")]
    public PostBaikeV1DraftsResponseDtoDraft? Draft { get; set; }

    /// <summary>
    /// <para>草稿信息</para>
    /// </summary>
    public record PostBaikeV1DraftsResponseDtoDraft
    {
        /// <summary>
        /// <para>草稿 ID</para>
        /// <para>必填：否</para>
        ...
        /// </summary>
        [JsonProperty("entity")]
        public PostBaikeV1DraftsResponseDtoDraftEntity? Entity { get; set; }

        /// <summary>
        /// <para>词条信息</para>
        /// </summary>
        public record PostBaikeV1DraftsResponseDtoDraftEntity
        {
            /// <summary>
            ...
            public PostBaikeV1DraftsResponseDtoDraftEntityRelatedMeta? RelatedMeta { get; set; }

            /// <summary>
            /// <para>外部系统关联数据</para>
            /// </summary>
            public record PostBaikeV1DraftsResponseDtoDraftEntityRelatedMeta
            {
                /// <summary>
            ...
            public PostBaikeV1DraftsResponseDtoDraftEntityStatistics? Statistics { get; set; }

            /// <summary>
            /// <para>富文本格式（当填写富文本内容时，description字段将会失效可不填写），支持的格式参考[飞书词典指南](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/baike-v1/overview)中的释义部分</para>
            /// </summary>
            public record PostBaikeV1DraftsResponseDtoDraftEntityStatistics
            {
                /// <summary>
                /// <para>点赞数量</para>
                /// <para>必填：是</para>
            ...
            public PostBaikeV1DraftsResponseDtoDraftEntityOuterInfo? OuterInfo { get; set; }

            /// <summary>
            /// <para>外部 id 关联数据</para>
            /// </summary>
            public record PostBaikeV1DraftsResponseDtoDraftEntityOuterInfo
            {
                /// <summary>
