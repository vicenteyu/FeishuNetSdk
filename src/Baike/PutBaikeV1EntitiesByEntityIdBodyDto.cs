...
// ************************************************************************
// <copyright file="PutBaikeV1EntitiesByEntityIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新免审词条 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PutBaikeV1EntitiesByEntityIdBodyDto
{
    /// <summary>
    /// <para>词条名</para>
    /// <para>必填：是</para>
    ...
    public PutBaikeV1EntitiesByEntityIdBodyDtoRelatedMeta? RelatedMeta { get; set; }

    /// <summary>
    /// <para>更多相关信息</para>
    /// </summary>
    public record PutBaikeV1EntitiesByEntityIdBodyDtoRelatedMeta
    {
        /// <summary>
        /// <para>相关联系人</para>
        /// <para>必填：否</para>
    ...
    public PutBaikeV1EntitiesByEntityIdBodyDtoOuterInfo? OuterInfo { get; set; }

    /// <summary>
    /// <para>外部系统关联数据</para>
    /// </summary>
    public record PutBaikeV1EntitiesByEntityIdBodyDtoOuterInfo
    {
        /// <summary>
