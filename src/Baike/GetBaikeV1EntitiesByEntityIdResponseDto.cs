...
/// </summary>
public record GetBaikeV1EntitiesByEntityIdResponseDto
{
    /// <summary>
    /// <para>词条</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonProperty("entity")]
    public GetBaikeV1EntitiesByEntityIdResponseDtoEntity? Entity { get; set; }

    /// <summary>
    /// <para>词条</para>
    /// </summary>
    public record GetBaikeV1EntitiesByEntityIdResponseDtoEntity
    {
        /// <summary>
        ...
        public GetBaikeV1EntitiesByEntityIdResponseDtoEntityRelatedMeta? RelatedMeta { get; set; }

        /// <summary>
        /// <para>更多相关信息</para>
        /// </summary>
        public record GetBaikeV1EntitiesByEntityIdResponseDtoEntityRelatedMeta
        {
            /// <summary>
            /// <para>相关联系人</para>
            /// <para>必填：否</para>
        ...
        public GetBaikeV1EntitiesByEntityIdResponseDtoEntityStatistics? Statistics { get; set; }

        /// <summary>
        /// <para>当前词条收到的反馈数据</para>
        /// </summary>
        public record GetBaikeV1EntitiesByEntityIdResponseDtoEntityStatistics
        {
            /// <summary>
            /// <para>累计点赞</para>
            /// <para>必填：是</para>
        ...
        public GetBaikeV1EntitiesByEntityIdResponseDtoEntityOuterInfo? OuterInfo { get; set; }

        /// <summary>
        /// <para>外部系统关联数据</para>
        /// </summary>
        public record GetBaikeV1EntitiesByEntityIdResponseDtoEntityOuterInfo
        {
            /// <summary>
