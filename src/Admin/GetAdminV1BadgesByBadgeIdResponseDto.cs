...
// ************************************************************************
// <copyright file="GetAdminV1BadgesByBadgeIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取勋章详情 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetAdminV1BadgesByBadgeIdResponseDto
{
    /// <summary>
    /// <para>勋章信息</para>
    /// <para>必填：否</para>
    ...
    public GetAdminV1BadgesByBadgeIdResponseDtoBadge? Badge { get; set; }

    /// <summary>
    /// <para>勋章信息</para>
    /// </summary>
    public record GetAdminV1BadgesByBadgeIdResponseDtoBadge
    {
        /// <summary>
