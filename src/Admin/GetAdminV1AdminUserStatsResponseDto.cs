...
//     MIT
// </copyright>
// <summary>获取用户维度的用户活跃和功能使用数据 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetAdminV1AdminUserStatsResponseDto : IPageableResponse<GetAdminV1AdminUserStatsResponseDto.AdminUserStat>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
