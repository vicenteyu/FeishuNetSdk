...
// ************************************************************************
// <copyright file="PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>修改授予名单 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto
{
    /// <summary>
    /// <para>授予名单</para>
    /// <para>必填：否</para>
    ...
    public PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrant? Grant { get; set; }

    /// <summary>
    /// <para>授予名单</para>
    /// </summary>
    public record PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrant
    {
        /// <summary>
        ...
        public PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrantRuleDetail RuleDetail { get; set; } = new();

        /// <summary>
        /// <para>规则详情</para>
        /// </summary>
        public record PutAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrantRuleDetail
        {
            /// <summary>
