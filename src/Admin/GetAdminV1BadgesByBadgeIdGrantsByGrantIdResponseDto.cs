...
// ************************************************************************
// <copyright file="GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取授予名单详情 响应体</summary>
// ************************************************************************
...
/// <para>文档地址：https://open.feishu.cn/document/server-docs/admin-v1/badge/badge-grant/get</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2freference%2fadmin-v1%2fbadge-grant%2fget</para>
/// </summary>
public record GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDto
{
    /// <summary>
    /// <para>授予名单信息</para>
    /// <para>必填：否</para>
    ...
    public GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrant? Grant { get; set; }

    /// <summary>
    /// <para>授予名单信息</para>
    /// </summary>
    public record GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrant
    {
        /// <summary>
        ...
        public GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrantRuleDetail RuleDetail { get; set; } = new();

        /// <summary>
        /// <para>规则详情</para>
        /// </summary>
        public record GetAdminV1BadgesByBadgeIdGrantsByGrantIdResponseDtoGrantRuleDetail
        {
            /// <summary>
