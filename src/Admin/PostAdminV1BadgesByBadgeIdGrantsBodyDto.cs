...
// ************************************************************************
// <copyright file="PostAdminV1BadgesByBadgeIdGrantsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建授予名单 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostAdminV1BadgesByBadgeIdGrantsBodyDto
{
    /// <summary>
    ...
    public PostAdminV1BadgesByBadgeIdGrantsBodyDtoRuleDetail RuleDetail { get; set; } = new();

    /// <summary>
    /// <para>规则详情</para>
    /// </summary>
    public record PostAdminV1BadgesByBadgeIdGrantsBodyDtoRuleDetail
    {
        /// <summary>
