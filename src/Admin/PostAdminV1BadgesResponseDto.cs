...
// ************************************************************************
// <copyright file="PostAdminV1BadgesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建勋章 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostAdminV1BadgesResponseDto
{
    /// <summary>
    /// <para>勋章的信息</para>
    /// <para>必填：否</para>
    ...
    public PostAdminV1BadgesResponseDtoBadge? Badge { get; set; }

    /// <summary>
    /// <para>勋章的信息</para>
    /// </summary>
    public record PostAdminV1BadgesResponseDtoBadge
    {
        /// <summary>
