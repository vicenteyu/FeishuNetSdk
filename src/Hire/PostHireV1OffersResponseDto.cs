...
/// </summary>
public record PostHireV1OffersResponseDto
{
    /// <summary>
    /// <para>Offer ID</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>Offer 申请表模板 ID，用于描述申请表单结构的元数据定义，即对申请表内容的描述。用户每一次更改 Offer 申请表模板信息，都会生成新的 schema_id，创建 Offer 时应传入最新的 schema_id，可从「获取Offer申请表模板信息」接口中获取</para>
    /// <para>必填：否</para>
