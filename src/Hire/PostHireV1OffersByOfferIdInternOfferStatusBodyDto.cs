...
// ************************************************************************
// <copyright file="PostHireV1OffersByOfferIdInternOfferStatusBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新实习 Offer 入/离职状态 请求体</summary>
// ************************************************************************
...
public record PostHireV1OffersByOfferIdInternOfferStatusBodyDto
{
    ...
    /// <summary>
    /// <para>入职表单信息</para>
    /// <para>**注意**：当 operation 为 `confirm_onboarding` 时，该字段必填</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>离职表单信息</para>
    /// <para>**注意**：当 operation 为 `offboard` 时，该字段必填</para>
    /// <para>必填：否</para>
    /// </summary>
