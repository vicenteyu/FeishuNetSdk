...
/// </summary>
public record GetHireV1WebsitesByWebsiteIdJobPostsResponseDto : IPageableResponse<GetHireV1WebsitesByWebsiteIdJobPostsResponseDto.WebsiteJobPost>
{
    /// <summary>
    /// <para>列表</para>
    /// <para>必填：否</para>
    ...
    public record WebsiteJobPost
    {
        ...
        public record CommonAddress
        {
            ...
            public record I18n
            {
                ...
                /// <para>职位地址英文名称</para>
                /// <para>必填：否</para>
                /// <para>示例值：address test list</para>
                /// </summary>
                [JsonPropertyName("en_us")]
                public string? EnUs { get; set; }
            }
