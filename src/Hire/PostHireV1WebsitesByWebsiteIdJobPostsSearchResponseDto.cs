...
/// </summary>
public record PostHireV1WebsitesByWebsiteIdJobPostsSearchResponseDto : IPageableResponse<PostHireV1WebsitesByWebsiteIdJobPostsSearchResponseDto.WebsiteJobPost>
{
    /// <summary>
    /// <para>列表</para>
    /// <para>必填：否</para>
