...
// ************************************************************************
// <copyright file="GetHireV1ReferralWebsitesJobPostsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取内推官网下的职位列表 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Hire;
/// <summary>
/// 获取内推官网下的职位列表 响应体
/// <para>获取内推官网下的职位列表。自定义数据暂不支持列表获取，请从「获取内推官网下职位广告详情」接口获取。</para>
