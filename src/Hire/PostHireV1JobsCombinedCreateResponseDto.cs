...
public record PostHireV1JobsCombinedCreateResponseDto
{
    ...
    public record PostHireV1JobsCombinedCreateResponseDtoJob
    {
        ...
        /// <para>必填：否</para>
        /// </summary>
        [JsonProperty("target_major_list")]
    ...
    /// <para>必填：否</para>
    /// </summary>
    [JsonProperty("interview_registration_schema_info")]
    ...
    /// <para>必填：否</para>
    /// </summary>
    [JsonProperty("onboard_registration_schema_info")]
