...
/// </summary>
public record GetHireV1TalentsResponseDto : IPageableResponse<GetHireV1TalentsResponseDto.Talent>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
    ...
    public record Talent
    {
        ...
        public record TalentCareerInfo
        {
            ...
            /// <para>必填：否</para>
            /// <para>可选值：<list type="bullet">
            /// <item>5：百度/阿里/腾讯</item>
            /// <item>6：头条/美团/滴滴</item>
            /// <item>14：互联网 100 强</item>
            /// </list></para>
            /// </summary>
            [JsonPropertyName("tag_list")]
            public int[]? TagList { get; set; }
