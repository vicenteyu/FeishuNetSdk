...
// ************************************************************************
// <copyright file="GetHireV1WebsitesByWebsiteIdJobPostsByJobPostIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取招聘官网下职位广告详情 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetHireV1WebsitesByWebsiteIdJobPostsByJobPostIdResponseDto
{
    /// <summary>
    /// <para>职位广告信息</para>
    /// <para>必填：否</para>
    ...
    public WebsiteJobPost? JobPost { get; set; }
    ...
    public record WebsiteJobPost
    {
        ...
        /// <summary>
        /// <para>职位过期时间，毫秒时间戳，「null」代表「长期有效」</para>
        /// <para>必填：否</para>
