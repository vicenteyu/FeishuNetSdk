...
// ************************************************************************
// <copyright file="GetHireV1PortalApplySchemasResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取申请表模板列表 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetHireV1PortalApplySchemasResponseDto : IPageableResponse<GetHireV1PortalApplySchemasResponseDto.RegistrationSchema>
{
    /// <summary>
    /// <para>申请表模板列表</para>
    /// <para>必填：否</para>
    ...
    public record RegistrationSchema
    {
        ...
        public record CommonSchema
        {
            ...
            public record I18n
            {
                ...
                /// <para>英文</para>
                /// <para>必填：否</para>
                /// <para>示例值：Basic Information</para>
                /// </summary>
            ...
            public record CommonSchemaSetting
            {
                ...
                {
                    /// <summary>
                    /// <para>选项信息，当字段类型为单选/多选时会返回该信息</para>
                    /// <para>必填：否</para>
                    /// </summary>
