...
/// <summary>
/// 查询人才内推信息 请求体
/// <para>根据人才查询内推信息列表，包含内推人信息、内推时间、投递ID等，按内推投递的`创建时间`从小到大排序返回。</para>
...
{
    /// <summary>
    /// <para>人才ID ，可通过[通过手机号或邮箱获取人才 ID](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/talent/batch_get_id)获取</para>
    /// <para>必填：是</para>
    ...
    /// <summary>
    /// <para>内推记录最早创建时间，毫秒时间戳。若不填，默认为全部，但最多返回200条</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>内推记录最晚创建时间，毫秒时间戳。若不填，默认为全部，但最多返回200条</para>
    /// <para>必填：否</para>
