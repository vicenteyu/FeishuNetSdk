...
/// </summary>
public record GetHireV1InterviewRecordsResponseDto : IPageableResponse<GetHireV1InterviewRecordsResponseDto.InterviewRecord>
{
    /// <summary>
    ...
    public record InterviewRecord
    {
        ...
        {
            /// <summary>
            /// <para>附件 ID，详情请参考[获取附件信息](https://open.feishu.cn/document/ukTMukTMukTM/uMzM1YjLzMTN24yMzUjN/hire-v1/attachment/get)</para>
            /// <para>必填：是</para>
