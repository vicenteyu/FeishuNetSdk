...
//     MIT
// </copyright>
// <summary>通过员工 ID 获取入职信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetHireV1EmployeesByEmployeeIdResponseDto
{
    /// <summary>
    /// <para>员工信息</para>
    /// <para>必填：否</para>
    ...
    public GetHireV1EmployeesByEmployeeIdResponseDtoEmployee? Employee { get; set; }

    /// <summary>
    /// <para>员工信息</para>
    /// </summary>
    public record GetHireV1EmployeesByEmployeeIdResponseDtoEmployee
    {
        /// <summary>
        /// <para>员工ID</para>
        /// <para>必填：否</para>
