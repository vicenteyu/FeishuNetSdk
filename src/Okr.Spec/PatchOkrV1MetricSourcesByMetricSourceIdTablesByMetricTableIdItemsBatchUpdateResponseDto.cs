...
/// </summary>
public record PatchOkrV1MetricSourcesByMetricSourceIdTablesByMetricTableIdItemsBatchUpdateResponseDto
{
    /// <summary>
    /// <para>指标项列表</para>
    /// <para>必填：否</para>
    ...
    public FailedMetricItem[]? FailedItems { get; set; }

    public record FailedMetricItem
    {
        /// <summary>
        /// <para>指标项ID</para>
        /// <para>必填：否</para>
