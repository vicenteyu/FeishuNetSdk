...
public record PostCorehrV2PersonsBodyDto
{
    ...
    public record Dependent
    {
        ...
        {
            /// <summary>
            /// <para>上传文件ID，可通过[【上传文件】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/person/upload)获取</para>
            /// <para>必填：否</para>
