...
public record PatchCorehrV2PersonsByPersonIdBodyDto
{
    ...
    public record BankAccount
    {
        ...
        /// <summary>
        /// <para>银行卡用途，可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)</para>
        /// <para>银行卡用途（Bank Account Usage）枚举定义获得</para>
        /// <para>必填：否</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>银行卡类型，可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)</para>
        /// <para>银行卡类型（Bank Account Type）枚举定义获得</para>
        /// <para>必填：否</para>
        /// </summary>
