...
// ************************************************************************
// <copyright file="PostCorehrV2DefaultCostCentersRemoveVersionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>删除默认成本中心 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV2DefaultCostCentersRemoveVersionBodyDto
{
    /// <summary>
    /// <para>员工雇佣 ID</para>
