...
/// </summary>
public record PostCorehrV2DepartmentsQueryMultiTimelineResponseDto : IPageableResponse<PostCorehrV2DepartmentsQueryMultiTimelineResponseDto.DepartmentTimeline>
{
    /// <summary>
    /// <para>部门信息</para>
    /// <para>必填：否</para>
