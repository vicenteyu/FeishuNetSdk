...
// ************************************************************************
// <copyright file="PostCorehrV2WorkforcePlanDetailRowBatchSaveBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量创建/更新明细行 请求体</summary>
// ************************************************************************
...
public record PostCorehrV2WorkforcePlanDetailRowBatchSaveBodyDto
{
    ...
    public record WorkforcePlanDetailRow
    {
        ...
        /// <para>- 当编制规划方案的时间范围是“按自然周期选择”时无法使用，按“自定义日期”可以使用</para>
        /// <para>必填：否</para>
        /// <para>最大长度：15</para>
        /// <para>最小长度：0</para>
        /// </summary>
        ...
        public record WorkforcePlanMultiPeriodValue
        {
            ...
            /// <summary>
            /// <para>对应自然周期的预增员数量。批量创建更新时，无需写入此字段。</para>
            /// <para>必填：否</para>
            /// <para>示例值：10.00</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>对应自然周期的预减员数量。批量创建更新时，无需写入此字段。</para>
            /// <para>必填：否</para>
            /// <para>示例值：10.00</para>
            /// </summary>
