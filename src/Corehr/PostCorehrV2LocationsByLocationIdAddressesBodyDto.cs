...
// ************************************************************************
// <copyright file="PostCorehrV2LocationsByLocationIdAddressesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>添加地点地址 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV2LocationsByLocationIdAddressesBodyDto
{
    /// <summary>
    /// <para>国家 / 地区 ID</para>
    ...
    /// <summary>
    /// <para>是否主要地址，一个地点只能存在一个主要地址，添加主要地址会将取消原主要地址</para>
