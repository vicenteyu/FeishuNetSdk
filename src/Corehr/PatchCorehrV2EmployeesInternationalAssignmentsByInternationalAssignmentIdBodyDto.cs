...
// ************************************************************************
// <copyright file="PatchCorehrV2EmployeesInternationalAssignmentsByInternationalAssignmentIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新外派信息 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PatchCorehrV2EmployeesInternationalAssignmentsByInternationalAssignmentIdBodyDto
{
    /// <summary>
    /// <para>外派工作地点 ID</para>
    ...
    public string? InternationalAssignmentType { get; set; }
