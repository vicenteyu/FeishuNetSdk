...
// ************************************************************************
// <copyright file="PostCorehrV2DefaultCostCentersCreateVersionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>添加默认成本中心 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV2DefaultCostCentersCreateVersionBodyDto
{
    /// <summary>
    /// <para>员工雇佣 ID</para>
    ...
    public record EmploymentDefaultCostCenter
    {
        ...
        /// <summary>
        /// <para>成本中心ID</para>
        /// <para>-可以调用[【搜索成本中心信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/cost_center/search)接口，获取成本中心信息中的成本中心ID。</para>
        /// <para>必填：否</para>
