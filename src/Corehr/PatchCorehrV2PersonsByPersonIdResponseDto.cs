...
public record PatchCorehrV2PersonsByPersonIdResponseDto
{
    ...
    public record PersonInfo
    {
        ...
        /// <summary>
        /// <para>婚姻状况，可通过[【获取字段详情】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/custom_field/get_by_param)获取，按如下参数查询即可：</para>
        ...
        public record Address
        {
            ...
            /// <summary>
            /// <para>地址 ID，在请求体值为空时生成新值，请注意保存</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>地址类型，可通过[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)地址类型（address_type）枚举定义获得；请选择一个使用，不支持同时多个类型</para>
            /// <para>必填：是</para>
            /// </summary>
        ...
        public record Education
        {
            ...
            /// <summary>
            /// <para>学位，枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)学位（degree）枚举定义部分获得</para>
            /// <para>必填：否</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>国家地区 ID，可通过[【查询国家/地区信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)接口获得</para>
            /// <para>必填：否</para>
            /// <para>示例值：1</para>
            /// </summary>
            [JsonPropertyName("country_region_id")]
        ...
        public record BankAccount
        {
            ...
            /// <summary>
            /// <para>货币 ID，可通过[【查询货币信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-currency/search)接口查询获得</para>
            /// <para>必填：否</para>
        ...
        {
            /// <summary>
            /// <para>国家证件类型，可通过[【批量查询国家证件类型】](/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/national_id_type/list)接口获取</para>
            /// <para>必填：是</para>
        ...
        public record Dependent
        {
            ...
            public record PersonName
            {
                ...
                /// <summary>
                /// <para>姓名类型，枚举值可通过文档[【飞书人事枚举常量】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/feishu-people-enum-constant)姓名类型（name_type）枚举定义获得</para>
                /// <para>必填：是</para>
                /// </summary>
                [JsonPropertyName("name_type")]
                public Enum NameType { get; set; } = new();
        ...
        /// <summary>
        /// <para>人才 ID，可通过[【获取人才信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)查询详细信息</para>
        /// <para>必填：否</para>
