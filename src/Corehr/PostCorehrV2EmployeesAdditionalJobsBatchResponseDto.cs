...
// ************************************************************************
// <copyright file="PostCorehrV2EmployeesAdditionalJobsBatchResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询兼职信息 响应体</summary>
// ************************************************************************
...
public record PostCorehrV2EmployeesAdditionalJobsBatchResponseDto
{
    ...
    public EmployeesAdditionalJob[]? Items { get; set; }

    /// <summary>
    /// <para>兼职信息</para>
    /// </summary>
    public record EmployeesAdditionalJob
    {
        /// <summary>
        /// <para>兼职记录 ID</para>
        /// <para>必填：否</para>
