...
// ************************************************************************
// <copyright file="PostCorehrV2ProbationAssessmentsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>新增试用期考核信息 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV2ProbationAssessmentsBodyDto
{
    /// <summary>
    /// <para>试用期人员的雇佣 ID</para>
    /// <para>必填：是</para>
    ...
    /// <para>试用期考核结果列表</para>
    /// </summary>
    public record AssessmentForCreate
    {
        /// <summary>
        /// <para>考核状态</para>
        /// <para>必填：是</para>
