...
// ************************************************************************
// <copyright file="GetCorehrV2EmployeesInternationalAssignmentsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询外派信息 响应体</summary>
// ************************************************************************
...
/// <para>文档地址：https://open.feishu.cn/document/corehr-v1/employee/job_data/employees-international_assignment/list</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2fcorehr-v2%2femployees-international_assignment%2flist</para>
/// </summary>
public record GetCorehrV2EmployeesInternationalAssignmentsResponseDto
{
    /// <summary>
    /// <para>外派信息</para>
    /// <para>必填：否</para>
    ...
    public EmployeesInternationalAssignment[]? Items { get; set; }

    /// <summary>
    /// <para>外派信息</para>
    /// </summary>
    public record EmployeesInternationalAssignment
    {
        /// <summary>
        /// <para>外派工作地点 ID</para>
        ...
        public record ObjectFieldData
        {
            ...
            /// <summary>
            /// <para>字段值，是json转义后的字符串，根据元数据定义不同，字段格式不同</para>
            /// <para>- 该返回值是将原始值 `json.Marshal` 后返回，使用 `json.Unmarshal` 解析到指定对象即可</para>
            /// <para>必填：是</para>
            /// <para>示例值：Sandy</para>
            /// </summary>
            [JsonPropertyName("value")]
    ...
    /// <summary>
    /// <para>无权限的雇佣ID</para>
    /// <para>- 在指定雇佣ID【employment_ids】查询时该参数生效</para>
    /// <para>- 类型与 user_id_type 一致</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("no_authority_ids")]
    public string[]? NoAuthorityIds { get; set; }
