...
// ************************************************************************
// <copyright file="PostCorehrV2ReportDetailRowBatchDeleteBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量删除填报行 请求体</summary>
// ************************************************************************
...
/// <para>文档地址：https://open.feishu.cn/document/corehr-v1/workforce_plan/batchDelete</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2fcorehr-v2%2freport_detail_row%2fbatchDelete</para>
/// </summary>
public record PostCorehrV2ReportDetailRowBatchDeleteBodyDto
{
    ...
    public record WorkforcePlanDetailRow
    {
        ...
        /// <summary>
        /// <para>预估在职人数相关信息。可从「设置-编制规划设置-编制规划XXX-集中填报」查看预估在职人数的时间，如果不存在该字段说明用户创建时即没有允许填写该字段，批量删除填报行时则无需给该字段，如果存在，用户需要查看预估在职人数的日期，使用示例值格式进行传参。（该字段无效，可忽略）</para>
        /// <para>必填：否</para>
        /// <para>最大长度：15</para>
        /// <para>最小长度：0</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>编制规划值。需与创建编制规划时指定的小数位数相匹配，若不匹配，则无法更新。小数位查看方式：「设置-编制规划-编制规划XXX」查看编制规划的小数位数。（该字段无效，可忽略）</para>
        /// <para>必填：否</para>
        /// <para>示例值：12</para>
        /// </summary>
