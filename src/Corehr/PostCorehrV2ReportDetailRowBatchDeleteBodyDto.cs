...
/// <summary>
/// 批量删除填报行 请求体
/// <para>批量删除填报行后，可在【设置-编制规划设置-编制规划XXX-集中填报】进行查看。</para>
/// <para>接口ID：7446337145820053508</para>
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/report_detail_row/batchDelete</para>
...
public record PostCorehrV2ReportDetailRowBatchDeleteBodyDto
{
    ...
    public record WorkforcePlanDetailRow
    {
        ...
        /// <summary>
        /// <para>预估在职人数相关信息。可从「设置-编制规划设置-编制规划XXX-集中填报」查看预估在职人数的时间，如果不存在该字段说明用户创建时即没有允许填写该字段，批量删除填报行时则无需给该字段，如果存在，用户需要查看预估在职人数的日期，使用示例值格式进行传参。</para>
        /// <para>必填：否</para>
        /// <para>最大长度：15</para>
        /// <para>最小长度：0</para>
        /// </summary>
