...
// ************************************************************************
// <copyright file="PostCorehrV2CostAllocationsBatchQueryBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询成本分摊 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV2CostAllocationsBatchQueryBodyDto
{
    /// <summary>
    /// <para>员工ID列表</para>
