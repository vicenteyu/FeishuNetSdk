...
/// </summary>
public record GetAttendanceV1GroupsByGroupIdListUserResponseDto : IPageableResponse<GetAttendanceV1GroupsByGroupIdListUserResponseDto.UserBase>
{
    /// <inheritdoc/>
    [JsonIgnore]
    public UserBase[]? Items => Users;
