...
// ************************************************************************
// <copyright file="PostOkrV2CyclesByCycleIdObjectivesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建 OKR 目标 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostOkrV2CyclesByCycleIdObjectivesBodyDto
{
    /// <summary>
    /// <para>目标的内容</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>目标的分类 ID，可通过[获取所有 OKR 分类]接口获取</para>
    /// <para>必填：否</para>
