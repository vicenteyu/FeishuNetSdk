...
// ************************************************************************
// <copyright file="PostOkrV2ObjectivesByObjectiveIdKeyResultsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>在目标下创建关键结果 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostOkrV2ObjectivesByObjectiveIdKeyResultsBodyDto
{
    /// <summary>
    /// <para>关键结果的内容</para>
    /// <para>必填：否</para>
