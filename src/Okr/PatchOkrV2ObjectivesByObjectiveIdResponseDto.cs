...
// ************************************************************************
// <copyright file="PatchOkrV2ObjectivesByObjectiveIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>编辑 OKR 目标 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PatchOkrV2ObjectivesByObjectiveIdResponseDto
{
    /// <summary>
    /// <para>目标</para>
    /// <para>必填：否</para>
    ...
    public ObjectiveSuffix? Objective { get; set; }

    /// <summary>
    /// <para>目标</para>
    /// </summary>
    public record ObjectiveSuffix
    {
        /// <summary>
        /// <para>目标的 ID</para>
        /// <para>必填：是</para>
