...
// ************************************************************************
// <copyright file="PutOkrV1ProgressRecordsByProgressIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新 OKR 进展记录 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PutOkrV1ProgressRecordsByProgressIdBodyDto
{
    /// <summary>
            ...
            public record ContentParagraph
            {
                ...
                public record ContentParagraphElement
                {
                    ...
                    public record ContentPerson
                    {
                        ...
                        /// <para>员工的OpenID</para>
                        /// <para>必填：否</para>
                        /// <para>示例值：ou_3bbe8a09c20e89cce9bff989ed84xxxx</para>
                        /// </summary>
