...
// ************************************************************************
// <copyright file="GetOkrV2ObjectivesByObjectiveIdProgressesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取目标下的进展记录 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetOkrV2ObjectivesByObjectiveIdProgressesResponseDto : IPageableResponse<GetOkrV2ObjectivesByObjectiveIdProgressesResponseDto.Progress>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
