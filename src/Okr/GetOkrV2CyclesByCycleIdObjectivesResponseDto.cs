...
// ************************************************************************
// <copyright file="GetOkrV2CyclesByCycleIdObjectivesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取用户 OKR 周期内的目标 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetOkrV2CyclesByCycleIdObjectivesResponseDto : IPageableResponse<GetOkrV2CyclesByCycleIdObjectivesResponseDto.Objective>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
    ...
    public record Objective
    {
        ...
        /// <para>目标的分类 ID</para>
        /// <para>必填：否</para>
        /// <para>示例值：7342342398472398475</para>
        /// <para>最大长度：20</para>
        /// <para>最小长度：1</para>
        /// </summary>
