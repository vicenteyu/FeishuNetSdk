...
// ************************************************************************
// <copyright file="PutOkrV1ProgressRecordsByProgressIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新 OKR 进展记录 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PutOkrV1ProgressRecordsByProgressIdResponseDto
{
    /// <summary>
    /// <para>OKR 进展ID</para>
    /// <para>必填：否</para>
            ...
            public record ContentParagraph
            {
                ...
                public record ContentParagraphElement
                {
                    ...
                    public record ContentDocsLink
                    {
                        ...
                        /// <para>飞书云文档链接地址</para>
                        /// <para>必填：否</para>
                        /// <para>示例值：https://example.feishu.cn/docx/xxxxxxxx</para>
                        /// </summary>
                        [JsonPropertyName("url")]
                        public string? Url { get; set; }
