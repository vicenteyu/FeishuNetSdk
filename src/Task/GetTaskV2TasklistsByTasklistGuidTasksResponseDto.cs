...
/// </summary>
public record GetTaskV2TasklistsByTasklistGuidTasksResponseDto : IPageableResponse<GetTaskV2TasklistsByTasklistGuidTasksResponseDto.TaskSummary>
{
    /// <summary>
    /// <para>任务摘要数据</para>
    /// <para>必填：否</para>
