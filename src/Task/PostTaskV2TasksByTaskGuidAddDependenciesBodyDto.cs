...
// ************************************************************************
// <copyright file="PostTaskV2TasksByTaskGuidAddDependenciesBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>添加依赖 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostTaskV2TasksByTaskGuidAddDependenciesBodyDto
{
    /// <summary>
    /// <para>要添加的依赖</para>
    /// <para>必填：否</para>
