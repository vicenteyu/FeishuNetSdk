...
// ************************************************************************
// <copyright file="PostTaskV1TasksByTaskIdCollaboratorsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>新增执行者 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostTaskV1TasksByTaskIdCollaboratorsResponseDto
{
    /// <summary>
    ...
    /// <para>返回创建成功后的任务执行者列表</para>
    /// </summary>
    public record PostTaskV1TasksByTaskIdCollaboratorsResponseDtoCollaborator
    {
        /// <summary>
        /// <para>任务执行者的 ID。</para>
