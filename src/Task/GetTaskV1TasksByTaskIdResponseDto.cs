...
// ************************************************************************
// <copyright file="GetTaskV1TasksByTaskIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询指定任务 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetTaskV1TasksByTaskIdResponseDto
{
    /// <summary>
    /// <para>返回任务资源详情</para>
    /// <para>必填：否</para>
    ...
    /// <para>返回任务资源详情</para>
    /// </summary>
    public record GetTaskV1TasksByTaskIdResponseDtoTask
    {
        /// <summary>
        ...
        /// <para>任务的截止时间设置</para>
        /// </summary>
        public record GetTaskV1TasksByTaskIdResponseDtoTaskDue
        {
            /// <summary>
        ...
        /// <para>任务关联的第三方平台来源信息</para>
        /// </summary>
        public record GetTaskV1TasksByTaskIdResponseDtoTaskOrigin
        {
            /// <summary>
            /// <para>任务来源的名称。</para>
            ...
            /// <para>任务关联的来源平台详情页链接</para>
            /// </summary>
            public record GetTaskV1TasksByTaskIdResponseDtoTaskOriginHref
            {
                /// <summary>
                /// <para>具体链接地址。</para>
