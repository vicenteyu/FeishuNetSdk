...
// ************************************************************************
// <copyright file="PostTaskV2TasksByTaskGuidRemoveMembersResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>移除任务成员 响应体</summary>
// ************************************************************************
...
{
    /// <summary>
    /// <para>移除成员后的任务数据</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("task")]
    public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTask? Task { get; set; }

    /// <summary>
    /// <para>移除成员后的任务数据</para>
    /// </summary>
    public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTask
    {
        /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskDue? Due { get; set; }

        /// <summary>
        /// <para>任务截止时间</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskDue
        {
            /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskOrigin? Origin { get; set; }

        /// <summary>
        /// <para>任务关联的第三方平台来源信息。创建是设置后就不可更改。</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskOrigin
        {
            /// <summary>
            ...
            public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskOriginHref? Href { get; set; }

            /// <summary>
            /// <para>任务关联的来源平台详情页链接</para>
            /// </summary>
            public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskOriginHref
            {
                /// <summary>
                /// <para>链接对应的地址</para>
                /// <para>必填：否</para>
        ...
        public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskCustomComplete? CustomComplete { get; set; }

        /// <summary>
        /// <para>任务的自定义完成配置</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskCustomComplete
        {
            /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskStart? Start { get; set; }

        /// <summary>
        /// <para>任务的开始时间</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidRemoveMembersResponseDtoTaskStart
        {
            /// <summary>
