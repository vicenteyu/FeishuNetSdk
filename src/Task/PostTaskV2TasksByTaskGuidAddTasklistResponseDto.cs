...
// ************************************************************************
// <copyright file="PostTaskV2TasksByTaskGuidAddTasklistResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>任务加入清单 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostTaskV2TasksByTaskGuidAddTasklistResponseDto
{
    /// <summary>
    /// <para>添加后的任务详情</para>
    /// <para>必填：否</para>
    ...
    public PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTask? Task { get; set; }

    /// <summary>
    /// <para>添加后的任务详情</para>
    /// </summary>
    public record PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTask
    {
        /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskDue? Due { get; set; }

        /// <summary>
        /// <para>任务截止时间</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskDue
        {
            /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskOrigin? Origin { get; set; }

        /// <summary>
        /// <para>任务关联的第三方平台来源信息。创建是设置后就不可更改。</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskOrigin
        {
            /// <summary>
            ...
            public PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskOriginHref? Href { get; set; }

            /// <summary>
            /// <para>任务关联的来源平台详情页链接</para>
            /// </summary>
            public record PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskOriginHref
            {
                /// <summary>
                /// <para>链接对应的地址</para>
                /// <para>必填：否</para>
        ...
        public PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskCustomComplete? CustomComplete { get; set; }

        /// <summary>
        /// <para>任务的自定义完成配置</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddTasklistResponseDtoTaskCustomComplete
        {
            /// <summary>
