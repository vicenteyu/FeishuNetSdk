...
// ************************************************************************
// <copyright file="PostTaskV1TasksByTaskIdCommentsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// </summary>
public record PostTaskV1TasksByTaskIdCommentsResponseDto
{
    /// <summary>
    /// <para>返回创建好的任务评论</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("comment")]
    public PostTaskV1TasksByTaskIdCommentsResponseDtoComment? Comment { get; set; }

    /// <summary>
    /// <para>返回创建好的任务评论</para>
    /// </summary>
    public record PostTaskV1TasksByTaskIdCommentsResponseDtoComment
    {
        /// <summary>
        /// <para>评论内容。</para>
