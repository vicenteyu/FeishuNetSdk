...
// ************************************************************************
// <copyright file="GetTaskV1TasksByTaskIdCommentsByCommentIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取评论详情 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetTaskV1TasksByTaskIdCommentsByCommentIdResponseDto
{
    /// <summary>
    ...
    /// <para>返回新的任务评论详情</para>
    /// </summary>
    public record GetTaskV1TasksByTaskIdCommentsByCommentIdResponseDtoComment
    {
        /// <summary>
        /// <para>评论内容。</para>
