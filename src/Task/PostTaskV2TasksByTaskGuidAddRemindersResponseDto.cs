...
// ************************************************************************
// <copyright file="PostTaskV2TasksByTaskGuidAddRemindersResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>添加任务提醒 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostTaskV2TasksByTaskGuidAddRemindersResponseDto
{
    /// <summary>
    /// <para>更新完成后的任务实体</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("task")]
    public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTask? Task { get; set; }

    /// <summary>
    /// <para>更新完成后的任务实体</para>
    /// </summary>
    public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTask
    {
        /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskDue? Due { get; set; }

        /// <summary>
        /// <para>任务截止时间</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskDue
        {
            /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskOrigin? Origin { get; set; }

        /// <summary>
        /// <para>任务关联的第三方平台来源信息。创建是设置后就不可更改。</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskOrigin
        {
            /// <summary>
            ...
            public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskOriginHref? Href { get; set; }

            /// <summary>
            /// <para>任务关联的来源平台详情页链接</para>
            /// </summary>
            public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskOriginHref
            {
                /// <summary>
                /// <para>链接对应的地址</para>
                /// <para>必填：否</para>
        ...
        public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskCustomComplete? CustomComplete { get; set; }

        /// <summary>
        /// <para>任务的自定义完成配置</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskCustomComplete
        {
            /// <summary>
        ...
        public PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskStart? Start { get; set; }

        /// <summary>
        /// <para>任务的开始时间</para>
        /// </summary>
        public record PostTaskV2TasksByTaskGuidAddRemindersResponseDtoTaskStart
        {
            /// <summary>
