...
// ************************************************************************
// <copyright file="PatchTaskV1TasksByTaskIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新任务 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PatchTaskV1TasksByTaskIdResponseDto
{
    /// <summary>
    ...
    /// <para>返回修改后的任务详情</para>
    /// </summary>
    public record PatchTaskV1TasksByTaskIdResponseDtoTask
    {
        /// <summary>
        ...
        /// <para>任务的截止时间设置</para>
        /// </summary>
        public record PatchTaskV1TasksByTaskIdResponseDtoTaskDue
        {
            /// <summary>
        ...
        /// <para>任务关联的第三方平台来源信息</para>
        /// </summary>
        public record PatchTaskV1TasksByTaskIdResponseDtoTaskOrigin
        {
            /// <summary>
            /// <para>任务来源的名称。</para>
            ...
            /// <para>任务关联的来源平台详情页链接</para>
            /// </summary>
            public record PatchTaskV1TasksByTaskIdResponseDtoTaskOriginHref
            {
                /// <summary>
                /// <para>具体链接地址。</para>
