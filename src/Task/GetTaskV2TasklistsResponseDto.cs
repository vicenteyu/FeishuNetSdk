...
// ************************************************************************
// <copyright file="GetTaskV2TasklistsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取清单列表 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetTaskV2TasklistsResponseDto : IPageableResponse<GetTaskV2TasklistsResponseDto.Tasklist>
{
    /// <summary>
    /// <para>清单数据列表</para>
    /// <para>必填：否</para>
