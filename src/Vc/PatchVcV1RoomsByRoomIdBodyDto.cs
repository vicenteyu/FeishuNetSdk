...
// ************************************************************************
// <copyright file="PatchVcV1RoomsByRoomIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新会议室 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PatchVcV1RoomsByRoomIdBodyDto
{
    /// <summary>
    /// <para>会议室名称</para>
    /// <para>必填：否</para>
    ...
    public PatchVcV1RoomsByRoomIdBodyDtoRoomStatus? RoomStatus { get; set; }

    /// <summary>
    /// <para>会议室状态</para>
    /// </summary>
    public record PatchVcV1RoomsByRoomIdBodyDtoRoomStatus
    {
        /// <summary>
        /// <para>是否启用会议室</para>
        /// <para>必填：是</para>
