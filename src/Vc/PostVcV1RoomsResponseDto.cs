...
// ************************************************************************
// <copyright file="PostVcV1RoomsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建会议室 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostVcV1RoomsResponseDto
{
    /// <summary>
    /// <para>会议室详情</para>
    /// <para>必填：否</para>
    ...
    public PostVcV1RoomsResponseDtoRoom? Room { get; set; }

    /// <summary>
    /// <para>会议室详情</para>
    /// </summary>
    public record PostVcV1RoomsResponseDtoRoom
    {
        /// <summary>
        /// <para>会议室ID</para>
        /// <para>必填：否</para>
        ...
        public PostVcV1RoomsResponseDtoRoomRoomStatus? RoomStatus { get; set; }

        /// <summary>
        /// <para>会议室状态</para>
        /// </summary>
        public record PostVcV1RoomsResponseDtoRoomRoomStatus
        {
            /// <summary>
            /// <para>是否启用会议室</para>
            /// <para>必填：是</para>
