...
// ************************************************************************
// <copyright file="PostVcV1MeetingsUnsubscriptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>取消订阅会议变更事件 请求体</summary>
// ************************************************************************
namespace FeishuNetSdk.Vc;
/// <summary>
/// 取消订阅会议变更事件 请求体
/// <para>取消订阅当前用户身份相关的会议资源变更事件。通过指定事件类型，来取消订阅会议资源对应的事件变更。</para>
...
/// </summary>
public record PostVcV1MeetingsUnsubscriptionBodyDto
{
    /// <summary>
    /// <para>事件类型</para>
    /// <para>**可选值有:**</para>
