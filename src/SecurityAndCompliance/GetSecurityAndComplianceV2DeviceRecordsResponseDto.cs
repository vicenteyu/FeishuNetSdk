...
// ************************************************************************
// <copyright file="GetSecurityAndComplianceV2DeviceRecordsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询设备信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetSecurityAndComplianceV2DeviceRecordsResponseDto : IPageableResponse<GetSecurityAndComplianceV2DeviceRecordsResponseDto.DeviceRecord>
{
    /// <summary>
    /// <para>设备列表</para>
    /// <para>必填：否</para>
    ...
    public DeviceRecord[]? Items { get; set; }
