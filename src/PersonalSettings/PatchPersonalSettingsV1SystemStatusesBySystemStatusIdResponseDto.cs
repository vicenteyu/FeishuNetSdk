...
// ************************************************************************
// <copyright file="PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>修改系统状态 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDto
{
    /// <summary>
    /// <para>系统状态</para>
    /// <para>必填：否</para>
    ...
    public PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDtoSystemStatus? SystemStatus { get; set; }

    /// <summary>
    /// <para>系统状态</para>
    /// </summary>
    public record PatchPersonalSettingsV1SystemStatusesBySystemStatusIdResponseDtoSystemStatus
    {
        /// <summary>
        /// <para>系统状态ID</para>
        /// <para>必填：否</para>
