...
// ************************************************************************
// <copyright file="PostPersonalSettingsV1SystemStatusesBySystemStatusIdBatchCloseResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量关闭系统状态 响应体</summary>
// ************************************************************************
...
public record PostPersonalSettingsV1SystemStatusesBySystemStatusIdBatchCloseResponseDto
{
    ...
    public SystemStatusUserCloseResultEntity[] ResultLists { get; set; } = [];
