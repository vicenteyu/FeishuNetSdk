...
// ************************************************************************
// <copyright file="PostMinutesV1MinutesSubscriptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>订阅妙记变更事件 请求体</summary>
// ************************************************************************
namespace FeishuNetSdk.Minutes;
/// <summary>
/// 订阅妙记变更事件 请求体
/// <para>订阅当前用户身份相关的妙记资源变更事件。通过指定事件类型，来订阅妙记资源不同的事件变更。</para>
...
/// </summary>
public record PostMinutesV1MinutesSubscriptionBodyDto
{
    /// <summary>
    /// <para>事件类型</para>
    /// <para>**可选值有:**</para>
