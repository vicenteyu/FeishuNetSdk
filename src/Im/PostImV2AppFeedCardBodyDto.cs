...
// ************************************************************************
// <copyright file="PostImV2AppFeedCardBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建应用消息流卡片 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostImV2AppFeedCardBodyDto
{
    /// <summary>
    /// <para>应用消息卡片</para>
    /// <para>必填：否</para>
    ...
    public OpenAppFeedCard? AppFeedCard { get; set; }
