...
// ************************************************************************
// <copyright file="PostImV1ChatsByChatIdMenuTreeSortResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>排序群菜单 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostImV1ChatsByChatIdMenuTreeSortResponseDto
{
    /// <summary>
    /// <para>排序后，群菜单信息</para>
    /// <para>必填：否</para>
    ...
    public record ChatMenuTree
    {
        ...
        public record ChatMenuTopLevel
        {
            ...
            public record ChatMenuTopLevelChatMenuItem
            {
                ...
                /// <item>NONE：无分类，当一级菜单下有二级菜单时，类型取值为 NONE。</item>
            ...
            public record ChatMenuSecondLevel
            {
                ...
                /// <summary>
                /// <para>二级菜单 ID，后续删除、修改、排序等群菜单管理操作均需要使用菜单 ID。</para>
                /// <para>必填：否</para>
                /// </summary>
                [JsonPropertyName("chat_menu_item")]
