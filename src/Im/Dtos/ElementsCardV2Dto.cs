...
// ************************************************************************
// <copyright file="ElementsCardV2Dto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>卡片内容 V2</summary>
// ************************************************************************
namespace FeishuNetSdk.Im.Dtos
{
    ...
    /// 卡片内容 V2
    /// </summary>
    public record ElementsCardV2Dto : MessageCard
    {
        /// <summary>
        ...
        public record ConfigSuffix
        {
            ...
            /// <summary>
            /// 卡片在流式更新时显示的摘要内容。支持自定义和多语言配置。
            /// </summary>
            [JsonPropertyName("summary")]
            public SummarySuffix? Summary { get; set; }

            /// <summary>
            /// 卡片在流式更新时显示的摘要内容。支持自定义和多语言配置。
            /// </summary>
            /// <param name="Content"></param>
            /// <param name="I18nContent"></param>
            public record SummarySuffix([property: JsonPropertyName("content")] string? Content = null, [property: JsonPropertyName("i18n_content")] I18nLanguage<string>? I18nContent = null);
