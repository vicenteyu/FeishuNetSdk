...
// ************************************************************************
// <copyright file="PostImV2AppFeedCardResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建应用消息流卡片 响应体</summary>
// ************************************************************************
...
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/group/im-v2/app_feed_card/create</para>
...
/// </summary>
public record PostImV2AppFeedCardResponseDto
{
    /// <summary>
    /// <para>失败的卡片</para>
    /// <para>必填：否</para>
    ...
    /// <para>卡片业务 ID</para>
    /// <para>必填：否</para>
    /// <para>示例值：b90ce43a-fca8-4f42-92f4-794bff206ee5</para>
    /// </summary>
    [JsonPropertyName("biz_id")]
