...
// ************************************************************************
// <copyright file="PostImV1ChatsByChatIdChatTabsUpdateTabsBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新会话标签页 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostImV1ChatsByChatIdChatTabsUpdateTabsBodyDto
{
    /// <summary>
    /// <para>会话标签页</para>
    /// <para>必填：否</para>
    ...
    {
        /// <summary>
        /// <para>会话标签页 ID，ID 可以在[添加会话标签页](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/create)或者[拉取会话标签页](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/im-v1/chat-tab/list_tabs)接口返回值中获取。</para>
        /// <para>必填：否</para>
        ...
        /// <summary>
        /// <para>会话标签页类型</para>
        /// <para>**注意**：只支持更新 doc、url 类型的标签页，其他字段为只读字段</para>
        /// <para>必填：是</para>
        /// <para>示例值：doc</para>
        ...
        public record ChatTabContent
        {
            ...
            /// <summary>
            /// <para>会议纪要，因不支持更新 meeting_minute 类型的会话标签页，该字段为只读字段，无需传值。</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>任务，因不支持更新 task 类型的会话标签页，该字段为只读字段，无需传值。</para>
            /// <para>必填：否</para>
