...
// ************************************************************************
// <copyright file="DeleteImV1ChatsByChatIdMenuTreeResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>删除群菜单 响应体</summary>
// ************************************************************************
...
/// </summary>
public record DeleteImV1ChatsByChatIdMenuTreeResponseDto
{
    /// <summary>
    /// <para>删除群菜单后，群内现有菜单的信息。</para>
    /// <para>必填：否</para>
    /// </summary>
