...
// ************************************************************************
// <copyright file="PostApprovalV4ExternalInstancesCheckBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>校验三方审批实例 请求体</summary>
// ************************************************************************
...
public record PostApprovalV4ExternalInstancesCheckBodyDto
{
    ...
    {
        /// <summary>
        /// <para>审批实例 ID。自定义配置，需要确保当前企业、应用内唯一。</para>
        /// <para>**注意**：调用本接口和[同步三方审批实例](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_instance/create)接口操作同一个三方审批实例时，需要确保所用的实例 ID 一致。</para>
        /// <para>必填：是</para>
        ...
        /// <summary>
        /// <para>审批实例最近更新时间，Unix 毫秒时间戳。</para>
        /// <para>必填：是</para>
        ...
        public record ExternalInstanceTask
        {
            ...
            /// <para>**注意**：调用本接口和[同步三方审批实例](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/approval-v4/external_instance/create)接口操作同一个三方审批实例内的任务时，需要确保所用的任务 ID 一致。</para>
            /// <para>必填：是</para>
