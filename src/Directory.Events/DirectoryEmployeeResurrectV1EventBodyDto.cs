...
// ************************************************************************
// <copyright file="DirectoryEmployeeResurrectV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>离职恢复在职 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Directory.Events;
/// <summary>
/// 离职恢复在职 事件体
/// <para>在员工取消离职时接收事件通知{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=employee&amp;event=resurrect)</para>
...
/// </summary>
public record DirectoryEmployeeResurrectV1EventBodyDto() : EventBodyDto("directory.employee.resurrect_v1")
{
    /// <summary>
    /// <para>员工实体</para>
    /// <para>必填：否</para>
