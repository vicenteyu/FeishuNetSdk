...
// ************************************************************************
// <copyright file="DirectoryDepartmentUpdatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>部门信息被修改 事件体</summary>
// ************************************************************************
...
/// </summary>
public record DirectoryDepartmentUpdatedV1EventBodyDto() : EventBodyDto("directory.department.updated_v1")
{
    /// <summary>
    ...
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("department_prev")]
    public DepartmentSuffix? DepartmentPrev { get; set; }

    /// <summary>
    /// <para>修改后的部门信息</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("department_curr")]
    public DepartmentSuffix? DepartmentCurr { get; set; }
