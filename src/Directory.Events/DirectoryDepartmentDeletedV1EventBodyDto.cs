...
// ************************************************************************
// <copyright file="DirectoryDepartmentDeletedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <summary>
/// 部门被删除 事件体
/// <para>在删除部门时接收事件通知。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=department&amp;event=deleted)</para>
...
/// </summary>
public record DirectoryDepartmentDeletedV1EventBodyDto() : EventBodyDto("directory.department.deleted_v1")
{
    /// <summary>
    /// <para>部门信息</para>
    /// <para>必填：否</para>
