...
// ************************************************************************
// <copyright file="DirectoryEmployeeToBeResignedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>员工被设置为待离职 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Directory.Events;
/// <summary>
/// 员工被设置为待离职 事件体
/// <para>当员工被设置为待离职时接收事件通知。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=employee&amp;event=to_be_resigned)</para>
...
/// </summary>
public record DirectoryEmployeeToBeResignedV1EventBodyDto() : EventBodyDto("directory.employee.to_be_resigned_v1")
{
    /// <summary>
    /// <para>员工实体</para>
    /// <para>必填：否</para>
    ...
    public record EmployeeEntity
    {
        ...
        {
            /// <summary>
            /// <para>EmployeeID 为App user的OpenID</para>
            /// <para>必填：否</para>
            /// </summary>
