...
// ************************************************************************
// <copyright file="DirectoryEmployeeRegularV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>待离职恢复为在职 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Directory.Events;
/// <summary>
/// 待离职恢复为在职 事件体
/// <para>在员工取消待离职时接收事件通知。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=employee&amp;event=regular)</para>
...
/// </summary>
public record DirectoryEmployeeRegularV1EventBodyDto() : EventBodyDto("directory.employee.regular_v1")
{
    /// <summary>
    /// <para>员工实体</para>
    /// <para>必填：否</para>
