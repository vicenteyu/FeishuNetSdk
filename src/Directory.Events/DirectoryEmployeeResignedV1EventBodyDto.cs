...
// ************************************************************************
// <copyright file="DirectoryEmployeeResignedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <summary>
/// 员工离职 事件体
/// <para>有员工离职时接收事件通知。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=employee&amp;event=resigned)</para>
...
/// </summary>
public record DirectoryEmployeeResignedV1EventBodyDto() : EventBodyDto("directory.employee.resigned_v1")
{
    /// <summary>
    /// <para>员工实体</para>
    /// <para>必填：否</para>
