...
// ************************************************************************
// <copyright file="DirectoryEmployeeCreatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <summary>
/// 员工入职 事件体
/// <para>在创建员工时接收事件通知{使用示例}(url=/api/tools/api_explore/api_explore_config?project=directory&amp;version=v1&amp;resource=employee&amp;event=created)</para>
...
/// </summary>
public record DirectoryEmployeeCreatedV1EventBodyDto() : EventBodyDto("directory.employee.created_v1")
{
    /// <summary>
    /// <para>员工实体</para>
    /// <para>必填：否</para>
