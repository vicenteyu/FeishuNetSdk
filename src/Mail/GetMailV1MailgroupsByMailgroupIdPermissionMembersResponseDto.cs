...
// ************************************************************************
// <copyright file="GetMailV1MailgroupsByMailgroupIdPermissionMembersResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取邮件组权限成员 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetMailV1MailgroupsByMailgroupIdPermissionMembersResponseDto : IPageableResponse<GetMailV1MailgroupsByMailgroupIdPermissionMembersResponseDto.MailgroupPermissionMember>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
