...
// ************************************************************************
// <copyright file="GetMailV1UserMailboxesByUserMailboxIdThreadsByThreadIdMessagesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询会话下邮件信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetMailV1UserMailboxesByUserMailboxIdThreadsByThreadIdMessagesResponseDto
{
    /// <summary>
    /// <para>邮件元数据列表</para>
    /// <para>必填：否</para>
    ...
    public MessageMeta[]? Items { get; set; }
    ...
    public record MessageMeta
    {
        ...
        /// <summary>
        /// <para>SMTP协议中使用的邮件ID（符合RFC 2822标准）</para>
        /// <para>必填：否</para>
        /// <para>示例值：123456@example.com</para>
        /// </summary>
