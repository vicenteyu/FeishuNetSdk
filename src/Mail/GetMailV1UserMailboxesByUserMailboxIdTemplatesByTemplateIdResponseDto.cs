...
// ************************************************************************
// <copyright file="GetMailV1UserMailboxesByUserMailboxIdTemplatesByTemplateIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取邮件模板 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetMailV1UserMailboxesByUserMailboxIdTemplatesByTemplateIdResponseDto
{
    /// <summary>
    /// <para>模板详情</para>
    /// <para>必填：否</para>
    ...
    public TemplateSuffix? Template { get; set; }
