...
/// </summary>
public record GetMailV1UserMailboxesByUserMailboxIdThreadsByThreadIdResponseDto
{
    /// <summary>
    /// <para>邮件会话</para>
    /// <para>必填：否</para>
    ...
    public ThreadSuffix? Thread { get; set; }

    /// <summary>
    /// <para>邮件会话</para>
    /// </summary>
    public record ThreadSuffix
    {
        /// <summary>
        /// <para>会话ID</para>
        /// <para>必填：否</para>
