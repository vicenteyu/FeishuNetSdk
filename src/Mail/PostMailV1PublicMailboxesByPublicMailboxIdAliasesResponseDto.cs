...
// ************************************************************************
// <copyright file="PostMailV1PublicMailboxesByPublicMailboxIdAliasesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建公共邮箱别名 响应体</summary>
// ************************************************************************
...
public record PostMailV1PublicMailboxesByPublicMailboxIdAliasesResponseDto
{
    ...
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("public_mailbox_alias")]
