...
// ************************************************************************
// <copyright file="PostMailV1UserMailboxesByUserMailboxIdMessagesBatchGetResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取邮件详情 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostMailV1UserMailboxesByUserMailboxIdMessagesBatchGetResponseDto
{
    /// <summary>
    /// <para>返回邮件内容</para>
    /// <para>必填：否</para>
