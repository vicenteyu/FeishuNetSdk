...
// ************************************************************************
// <copyright file="GetMailV1PublicMailboxesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询所有公共邮箱 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetMailV1PublicMailboxesResponseDto : IPageableResponse<GetMailV1PublicMailboxesResponseDto.PublicMailbox>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
