    ...
    where T2 : EventBodyDto
{
    ...
    /// <returns></returns>
    System.Threading.Tasks.Task ExecuteAsync(T1 input, CancellationToken cancellationToken = default);
}
    ...
    where T3 : CallbackResponseDto
{
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    System.Threading.Tasks.Task<T3> ExecuteAsync(T1 input, CancellationToken cancellationToken = default);
}
