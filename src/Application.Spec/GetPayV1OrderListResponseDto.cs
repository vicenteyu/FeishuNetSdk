...
// ************************************************************************
// <copyright file="GetPayV1OrderListResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <para>文档地址：https://open.feishu.cn/document/server-docs/application-v6/appstore-paid-info/query-an-app-tenant%E2%80%99s-paid-orders</para>
...
public record GetPayV1OrderListResponseDto : IPageableResponse<GetPayV1OrderListResponseDto.Order>
{
    ...
    public record Order
    {
        ...
        public string? OrderPayPrice { get; set; }
