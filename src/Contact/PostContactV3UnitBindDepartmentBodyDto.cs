...
// ************************************************************************
// <copyright file="PostContactV3UnitBindDepartmentBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>建立部门与单位的绑定关系 请求体</summary>
// ************************************************************************
...
public record PostContactV3UnitBindDepartmentBodyDto
{
    ...
    /// <summary>
    /// <para>单位关联的部门 ID，ID 类型与 department_id_type 的取值保持一致。</para>
