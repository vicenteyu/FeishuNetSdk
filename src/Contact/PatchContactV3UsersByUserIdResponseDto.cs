...
/// </summary>
public record PatchContactV3UsersByUserIdResponseDto
{
    /// <summary>
    /// <para>用户信息</para>
    /// <para>必填：否</para>
    ...
    public PatchContactV3UsersByUserIdResponseDtoUser? User { get; set; }

    /// <summary>
    /// <para>用户信息</para>
    /// </summary>
    public record PatchContactV3UsersByUserIdResponseDtoUser
    {
        /// <summary>
        ...
        /// <summary>
        /// <para>用户所属部门的 ID 列表，一个用户可属于多个部门。ID 值的类型与查询参数中的 department_id_type 的取值保持一致。</para>
        /// <para>必填：否</para>
        ...
        /// <summary>
        /// <para>用户的直接主管的用户ID。ID 值的类型与查询参数中的user_id_type 的取值保持一致。</para>
        /// <para>必填：否</para>
        /// <para>示例值：ou_7dab8a3d3cdcc9da365777c7ad535d62</para>
        /// </summary>
        ...
        {
            /// <summary>
            /// <para>排序信息对应的部门 ID，表示用户所在的、且需要排序的部门。ID 值的类型与查询参数中的 department_id_type 的取值保持一致。</para>
            /// <para>必填：否</para>
            /// <para>示例值：od-4e6ac4d14bcd5071a37a39de902c7141</para>
            /// </summary>
        ...
        public record UserCustomAttr
        {
            ...
            public record UserCustomAttrValue
            {
                ...
                {
                    /// <summary>
                    /// <para>引用人员的 user_id。ID 类型与查询参数 user_id_type 的取值保持一致。</para>
                    /// <para>必填：是</para>
