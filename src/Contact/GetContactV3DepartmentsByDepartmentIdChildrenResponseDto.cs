...
/// </summary>
public record GetContactV3DepartmentsByDepartmentIdChildrenResponseDto : IPageableResponse<GetContactV3DepartmentsByDepartmentIdChildrenResponseDto.Department>
{
    /// <summary>
    /// <para>是否还有更多项</para>
    /// <para>必填：否</para>
