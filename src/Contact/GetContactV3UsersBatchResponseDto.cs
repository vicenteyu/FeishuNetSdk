...
// ************************************************************************
// <copyright file="GetContactV3UsersBatchResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取用户信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetContactV3UsersBatchResponseDto
{
    /// <summary>
    /// <para>查询到的用户信息。</para>
    /// <para>**说明**：如有不在应用通讯录权限范围内的用户，则不会返回相应的信息。</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    public record User
    {
        ...
        /// <summary>
        /// <para>用户所属部门的 ID 列表，一个用户可属于多个部门。ID 类型与查询参数 department_id_type 的取值保持一致。</para>
        /// <para>必填：否</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>用户的直接主管的用户ID。ID 类型与查询参数 user_id_type 的取值保持一致。</para>
        /// <para>必填：否</para>
        /// <para>示例值：ou_7dab8a3d3cdcc9da365777c7ad535d62</para>
        /// </summary>
        ...
        {
            /// <summary>
            /// <para>排序信息对应的部门 ID，表示用户所在的、且需要排序的部门。ID 值的类型与查询参数 department_id_type 的取值保持一致。</para>
            /// <para>必填：否</para>
