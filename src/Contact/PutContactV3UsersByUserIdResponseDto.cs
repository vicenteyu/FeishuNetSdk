...
// ************************************************************************
// <copyright file="PutContactV3UsersByUserIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新用户所有信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PutContactV3UsersByUserIdResponseDto
{
    /// <summary>
    /// <para>用户信息</para>
    /// <para>必填：否</para>
    ...
    public PutContactV3UsersByUserIdResponseDtoUser? User { get; set; }

    /// <summary>
    /// <para>用户信息</para>
    /// </summary>
    public record PutContactV3UsersByUserIdResponseDtoUser
    {
        /// <summary>
