...
// ************************************************************************
// <copyright file="PostCompensationV1SocialPlansQueryResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>根据方案ID和生效日期批量查询参保方案 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.CompensationManagement;
/// <summary>
/// 根据方案ID和生效日期批量查询参保方案 响应体
...
/// </summary>
public record PostCompensationV1SocialPlansQueryResponseDto
{
    /// <summary>
    /// <para>方案列表</para>
    /// <para>必填：否</para>
    ...
    public record SocialPlan
    {
        ...
        /// <para>参保方案ID</para>
        /// <para>必填：是</para>
        /// <para>示例值：7198138281677325868</para>
        /// <para>最大长度：64</para>
        /// <para>最小长度：1</para>
        /// </summary>
        ...
        /// <para>参保方案版本ID</para>
        /// <para>必填：是</para>
        /// <para>示例值：7198138281677358636</para>
        /// <para>最大长度：64</para>
        /// <para>最小长度：1</para>
        /// </summary>
        ...
        public record I18n
        {
            ...
            /// <para>英文名称</para>
            /// <para>必填：否</para>
            /// <para>示例值：sky-provident fund plan test</para>
            /// </summary>
        ...
        public record SocialPlanItemDetail
        {
            ...
            /// <para>必填：是</para>
            /// <para>示例值：7200726176044680748</para>
            /// <para>最大长度：64</para>
            /// <para>最小长度：1</para>
            /// </summary>
            ...
            public record I18n
            {
                ...
                /// <para>英文名称</para>
                /// <para>必填：否</para>
                /// <para>示例值：endowment insurance</para>
                /// </summary>
                [JsonPropertyName("en_us")]
                public string? EnUs { get; set; }
            }
