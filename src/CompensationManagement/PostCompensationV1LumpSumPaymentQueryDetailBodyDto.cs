...
// ************************************************************************
// <copyright file="PostCompensationV1LumpSumPaymentQueryDetailBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询一次性支付授予明细 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostCompensationV1LumpSumPaymentQueryDetailBodyDto
{
    /// <summary>
    /// <para>一次性支付明细 id，可通过本接口获取</para>
    /// <para>必填：否</para>
    /// <para>最大长度：500</para>
    /// <para>最小长度：0</para>
    /// </summary>
    ...
    /// <para>最小长度：0</para>
    /// </summary>
    [JsonPropertyName("record_unique_ids")]
    public string[]? RecordUniqueIds { get; set; }
    ...
    /// </list></para>
    /// </summary>
    [JsonPropertyName("issuance_ways")]
    public string[]? IssuanceWays { get; set; }
    ...
    /// </list></para>
    /// </summary>
    [JsonPropertyName("issuance_statuses")]
    public string[]? IssuanceStatuses { get; set; }
    ...
    /// <para>最小长度：0</para>
    /// </summary>
    [JsonPropertyName("issuance_date_gte")]
    public string? IssuanceDateGte { get; set; }
    ...
    /// <para>最小长度：0</para>
    /// </summary>
    [JsonPropertyName("issuance_date_lte")]
    public string? IssuanceDateLte { get; set; }
