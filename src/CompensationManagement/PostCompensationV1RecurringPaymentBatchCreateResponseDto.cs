...
// ************************************************************************
// <copyright file="PostCompensationV1RecurringPaymentBatchCreateResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量创建经常性支付记录 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostCompensationV1RecurringPaymentBatchCreateResponseDto
{
    /// <summary>
    /// <para>每条记录的操作结果。对于创建成功的记录，会返回创建后的经常性支付记录id</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    public record RecurringPaymentOperateResult
    {
        ...
        /// <item>21270315："The distribution start date and end date overlap" 发放开始日期和结束日期有重叠</item>
        /// <item>21270316："Issuing country is empty" 发放国家为空</item>
        /// <item>21270317："Issuing country does not exist" 发放国家不存在</item>
        /// <item>21270318："The single payment amount cannot be 0" 单次发放金额不允许为0</item>
        /// </list></para>
        /// </summary>
