...
// ************************************************************************
// <copyright file="PostCompensationV1LumpSumPaymentBatchRemoveResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量删除一次性支付记录 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostCompensationV1LumpSumPaymentBatchRemoveResponseDto
{
    /// <summary>
    ...
    public record LumpSumPaymentOperateResult
    {
        ...
        /// <item>21270211："The bonus details amount format is incorrect" 奖金明细金额格式不正</item>
