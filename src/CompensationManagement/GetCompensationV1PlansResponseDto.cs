...
// ************************************************************************
// <copyright file="GetCompensationV1PlansResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询薪资方案 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetCompensationV1PlansResponseDto : IPageableResponse<GetCompensationV1PlansResponseDto.PlanDetail>
{
    /// <summary>
    /// <para>薪资方案信息列表</para>
    /// <para>必填：是</para>
