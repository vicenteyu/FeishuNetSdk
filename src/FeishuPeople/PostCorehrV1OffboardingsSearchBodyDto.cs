...
public record PostCorehrV1OffboardingsSearchBodyDto
{
    ...
    /// <summary>
    /// <para>离职审批发起时间（搜索的起始范围），请按照秒级时间戳格式传入。该字段非必填，需要与搜索范围结束一同使用。</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>离职审批发起时间（搜索的结束范围），请按照秒级时间戳格式传入。该字段非必填，需要与搜索范围开始一同使用。</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>期望离职日期（搜索的起始范围），请按日期格式传入。该字段非必填，需要与搜索范围结束一同使用</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>期望离职日期（搜索的结束范围），请按日期格式传入。该字段非必填，需要与搜索范围开始一同使用。</para>
    /// <para>必填：否</para>
    /// <para>示例值：2022-01-01</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>离职日期（搜索的起始范围），请按日期格式传入。该字段非必填，需要与搜索范围结束一同使用。</para>
    /// <para>必填：否</para>
    /// <para>示例值：2022-01-01</para>
    /// </summary>
    ...
    /// <summary>
    /// <para>离职日期（搜索的结束范围），该字段非必填，需要与搜索范围开始一同使用。</para>
    /// <para>必填：否</para>
    /// <para>示例值：2022-01-01</para>
    /// </summary>
