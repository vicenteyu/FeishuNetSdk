...
// ************************************************************************
// <copyright file="PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>修改字段枚举值选项 请求体</summary>
// ************************************************************************
...
public record PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDto
{
    ...
    /// <para>必填：是</para>
    /// </summary>
    [JsonPropertyName("enum_field_option")]
    public PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDtoEnumFieldOption EnumFieldOption { get; set; } = new();

    /// <summary>
    /// <para>枚举选项</para>
    /// </summary>
    public record PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDtoEnumFieldOption
    {
        /// <summary>
        ...
        public PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDtoEnumFieldOptionName Name { get; set; } = new();

        /// <summary>
        /// <para>选项名称（需填写至少一个语种）</para>
        /// </summary>
        public record PostCorehrV1CommonDataMetaDataEditEnumOptionBodyDtoEnumFieldOptionName
        {
            /// <summary>
            /// <para>中文</para>
            /// <para>必填：否</para>
