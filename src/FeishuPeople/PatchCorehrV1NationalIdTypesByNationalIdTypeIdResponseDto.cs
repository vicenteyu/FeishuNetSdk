...
// ************************************************************************
// <copyright file="PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新国家证件类型 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDto
{
    /// <summary>
    /// <para>国家证件类型</para>
    /// <para>必填：否</para>
    ...
    public PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDtoNationalIdType? NationalIdType { get; set; }

    /// <summary>
    /// <para>国家证件类型</para>
    /// </summary>
    public record PatchCorehrV1NationalIdTypesByNationalIdTypeIdResponseDtoNationalIdType
    {
        /// <summary>
        /// <para>证件类型 ID</para>
        /// <para>必填：否</para>
