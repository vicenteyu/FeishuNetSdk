...
// ************************************************************************
// <copyright file="PatchCorehrV1DepartmentsByDepartmentIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新部门 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PatchCorehrV1DepartmentsByDepartmentIdResponseDto
{
    /// <summary>
    /// <para>部门</para>
    /// <para>必填：否</para>
    ...
    public PatchCorehrV1DepartmentsByDepartmentIdResponseDtoDepartment? Department { get; set; }

    /// <summary>
    /// <para>部门</para>
    /// </summary>
    public record PatchCorehrV1DepartmentsByDepartmentIdResponseDtoDepartment
    {
        /// <summary>
        /// <para>部门 ID</para>
        /// <para>必填：否</para>
