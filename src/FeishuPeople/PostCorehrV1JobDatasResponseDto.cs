...
/// </summary>
public record PostCorehrV1JobDatasResponseDto
{
    /// <summary>
    /// <para>创建成功返回job data信息</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("job_data")]
    public PostCorehrV1JobDatasResponseDtoJobData? JobData { get; set; }
    ...
    public record PostCorehrV1JobDatasResponseDtoJobData
    {
        ...
        /// <summary>
        /// <para>任职公司，枚举值及详细信息可通过[【查询单个序列】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/company/get)接口查询获得</para>
        /// <para>必填：否</para>
