...
// ************************************************************************
// <copyright file="GetCorehrV1CustomFieldsGetByParamResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取字段详情 响应体</summary>
// ************************************************************************
...
public record GetCorehrV1CustomFieldsGetByParamResponseDto
{
    ...
    {
        /// <summary>
        /// <para>字段 API name，即字段的唯一标识</para>
        /// <para>必填：否</para>
        ...
        /// <para>- 4：枚举 Enum，“单选”和“单选”属于该类型</para>
