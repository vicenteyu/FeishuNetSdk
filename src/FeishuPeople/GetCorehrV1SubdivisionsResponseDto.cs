...
// ************************************************************************
// <copyright file="GetCorehrV1SubdivisionsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询省份/行政区信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetCorehrV1SubdivisionsResponseDto : IPageableResponse<GetCorehrV1SubdivisionsResponseDto.Subdivision>
{
    /// <summary>
    /// <para>省份/行政区信息</para>
    /// <para>必填：否</para>
