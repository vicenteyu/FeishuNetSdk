...
// ************************************************************************
// <copyright file="GetCorehrV1PreHiresResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询待入职人员 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetCorehrV1PreHiresResponseDto : IPageableResponse<GetCorehrV1PreHiresResponseDto.PreHireQuery>
{
    /// <summary>
    /// <para>查询的待入职信息</para>
    /// <para>必填：否</para>
    ...
    public record PreHireQuery
    {
        ...
        /// <summary>
        /// <para>部门ID，可通过[【批量查询部门】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/batch_get)接口获取</para>
        /// <para>必填：否</para>
        /// <para>示例值：656464648662</para>
        /// </summary>
