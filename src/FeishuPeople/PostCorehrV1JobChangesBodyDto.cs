...
/// </summary>
public record PostCorehrV1JobChangesBodyDto
{
    /// <summary>
    /// <para>异动方式</para>
    /// <para>必填：是</para>
    ...
    public PostCorehrV1JobChangesBodyDtoTransferInfo TransferInfo { get; set; } = new();

    /// <summary>
    /// <para>异动详细信息，以下参数如不传，无默认值，代表对应数据无异动</para>
    /// </summary>
    public record PostCorehrV1JobChangesBodyDtoTransferInfo
    {
        /// <summary>
        /// <para>备注</para>
        /// <para>必填：否</para>
        ...
        /// <summary>
        /// <para>原部门ID，可通过[【批量查询部门】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/department/batch_get)接口获取</para>
        /// <para>必填：否</para>
        ...
        /// <summary>
        /// <para>原序列ID，可通过[【批量查询序列】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/corehr-v1/job_family/list)接口获取</para>
        /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>发起异动幂等标志，发起失败可以重新用此标志继续请求</para>
    /// <para>必填：否</para>
    ...
    /// <summary>
    /// <para>异动发起人 ID，可通过[【搜索员工信息】](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/employee/search)接口获取</para>
    /// <para>必填：否</para>
    /// <para>示例值：ou_a294793e8fa21529f2a60e3e9de45520</para>
    /// </summary>
