...
// ************************************************************************
// <copyright file="PostCorehrV1NationalIdTypesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建国家证件类型 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostCorehrV1NationalIdTypesResponseDto
{
    /// <summary>
    /// <para>创建成功的国家证件类型数据</para>
    /// <para>必填：否</para>
    /// </summary>
    [JsonPropertyName("national_id_type")]
    public PostCorehrV1NationalIdTypesResponseDtoNationalIdType? NationalIdType { get; set; }

    /// <summary>
    /// <para>创建成功的国家证件类型数据</para>
    /// </summary>
    public record PostCorehrV1NationalIdTypesResponseDtoNationalIdType
    {
        /// <summary>
        /// <para>证件类型 ID</para>
        /// <para>必填：否</para>
