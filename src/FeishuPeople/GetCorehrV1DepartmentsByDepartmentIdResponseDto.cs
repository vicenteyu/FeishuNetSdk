...
// ************************************************************************
// <copyright file="GetCorehrV1DepartmentsByDepartmentIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询单个部门 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetCorehrV1DepartmentsByDepartmentIdResponseDto
{
    /// <summary>
    /// <para>部门信息</para>
    /// <para>必填：否</para>
    ...
    public GetCorehrV1DepartmentsByDepartmentIdResponseDtoDepartment? Department { get; set; }

    /// <summary>
    /// <para>部门信息</para>
    /// </summary>
    public record GetCorehrV1DepartmentsByDepartmentIdResponseDtoDepartment
    {
        /// <summary>
        /// <para>部门 ID</para>
        /// <para>必填：否</para>
