...
// ************************************************************************
// <copyright file="PatchCorehrV1CompaniesByCompanyIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新公司 响应体</summary>
// ************************************************************************
...
public record PatchCorehrV1CompaniesByCompanyIdResponseDto
{
    ...
    public PatchCorehrV1CompaniesByCompanyIdResponseDtoCompany? Company { get; set; }

    /// <summary>
    /// <para>公司</para>
    /// </summary>
    public record PatchCorehrV1CompaniesByCompanyIdResponseDtoCompany
    {
        /// <summary>
        /// <para>公司ID</para>
        /// <para>必填：否</para>
        ...
        public PatchCorehrV1CompaniesByCompanyIdResponseDtoCompanyHiberarchyCommon HiberarchyCommon { get; set; } = new();

        /// <summary>
        /// <para>公司基本信息，该结构维护了公司的名称、编码、启用状态、上级公司等基础信息。</para>
        /// </summary>
        public record PatchCorehrV1CompaniesByCompanyIdResponseDtoCompanyHiberarchyCommon
        {
            /// <summary>
            /// <para>上级组织</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>公司启用状态，true为启用，false为停用</para>
            /// <para>必填：是</para>
            /// <para>示例值：true</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>树形排序，代表同层级的部门排序序号（该功能暂不支持，可忽略）</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>列表排序，代表所有部门的混排序号（该功能暂不支持，可忽略）</para>
            /// <para>必填：否</para>
        ...
        public PatchCorehrV1CompaniesByCompanyIdResponseDtoCompanyCurrency? Currency { get; set; }

        /// <summary>
        /// <para>默认币种</para>
        /// </summary>
        public record PatchCorehrV1CompaniesByCompanyIdResponseDtoCompanyCurrency
        {
            /// <summary>
            /// <para>货币id</para>
            /// <para>必填：否</para>
