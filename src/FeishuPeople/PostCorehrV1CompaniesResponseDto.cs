...
public record PostCorehrV1CompaniesResponseDto
{
    ...
    public record PostCorehrV1CompaniesResponseDtoCompany
    {
        ...
        {
            /// <summary>
            /// <para>国家 / 地区id。若选择中国大陆、中国香港、中国澳门，则需要指定主要行政区（中国大陆为省份）、城市、区/县（中国香港为地区）</para>
            /// <para>若选择中国台湾，则需要指定主要行政区（中国台湾为省/地区）、城市、区/县（中国台湾为区）。可通过[请求接口](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region/search)查询获取。</para>
            /// <para>必填：是</para>
            ...
            /// <summary>
            /// <para>主要行政区id。可通过[请求接口](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-country_region_subdivision/search)查询获取。</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>城市id。可通过[请求接口](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-city/search)查询获取。</para>
            /// <para>必填：否</para>
            ...
            /// <summary>
            /// <para>区/县id，可通过[请求接口](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/corehr-v2/basic_info-district/search)查询获取。</para>
            /// <para>必填：否</para>
