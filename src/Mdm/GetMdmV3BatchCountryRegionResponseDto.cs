...
// ************************************************************************
// <copyright file="GetMdmV3BatchCountryRegionResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>根据主数据编码批量查询国家/地区 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.Mdm;
/// <summary>
/// 根据主数据编码批量查询国家/地区 响应体
...
/// </summary>
public record GetMdmV3BatchCountryRegionResponseDto
{
    /// <summary>
    /// <para>国家/地区目录列表</para>
    /// <para>必填：否</para>
