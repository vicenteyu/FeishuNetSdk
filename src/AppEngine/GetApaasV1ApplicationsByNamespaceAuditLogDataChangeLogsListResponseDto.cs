...
// ************************************************************************
// <copyright file="GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogsListResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询数据变更日志列表 响应体</summary>
// ************************************************************************
...
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/apaas-v1/application-audit_log/data_change_logs_list</para>
...
/// </summary>
public record GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogsListResponseDto
{
    /// <summary>
    /// <para>数据变更日志查询结果列表详情信息</para>
    /// <para>必填：否</para>
    /// </summary>
    ...
    public record AuditLogEsField
    {
        ...
        public record LookupWithAvatar
        {
            ...
            /// <para>用户邮箱</para>
            /// <para>必填：否</para>
            /// <para>示例值：guojin.jim@bytedance.com</para>
            /// </summary>
        ...
        /// <summary>
        /// <para>登录类型:11001-飞书登录;11003-账号密码登录</para>
        /// <para>必填：否</para>
        /// <para>示例值：11001</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        ...
        /// <summary>
        /// <para>终端类型:13002-PC类型;13003-Web类型</para>
        /// <para>必填：否</para>
        /// <para>示例值：2</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        ...
        /// <summary>
        /// <para>系统类型:14002-window;14001-未知</para>
        /// <para>必填：否</para>
        /// <para>示例值：14002</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        ...
        /// <summary>
        /// <para>审计域:15001-企业管理后台;15002-应用管理后 台;15003-应用开发平台</para>
        /// <para>必填：否</para>
        /// <para>示例值：15001</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        ...
        /// <summary>
        /// <para>环境类型:16001-沙箱环境;16003-线上环境</para>
        /// <para>必填：否</para>
        /// <para>示例值：16003</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        ...
        public object? OpDetail { get; set; }
        ...
        /// <para>失败原因</para>
        /// <para>必填：否</para>
        /// <para>示例值：{"zh":"失败信息"}</para>
        /// </summary>
        [JsonPropertyName("failed_reason_i18n")]
        public object? FailedReasonI18n { get; set; }
