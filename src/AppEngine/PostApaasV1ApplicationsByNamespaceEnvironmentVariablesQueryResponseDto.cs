...
// ************************************************************************
// <copyright file="PostApaasV1ApplicationsByNamespaceEnvironmentVariablesQueryResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询环境变量列表 响应体</summary>
// ************************************************************************
namespace FeishuNetSdk.AppEngine;
/// <summary>
/// 查询环境变量列表 响应体
/// <para>查询基于飞书 aPaaS 开发的应用的环境变量列表</para>
...
/// </summary>
public record PostApaasV1ApplicationsByNamespaceEnvironmentVariablesQueryResponseDto
{
    /// <summary>
    /// <para>环境变量列表</para>
    /// <para>必填：否</para>
    ...
    public EnvironmentVariable[]? Items { get; set; }
