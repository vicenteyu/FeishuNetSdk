...
// ************************************************************************
// <copyright file="GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogDetailResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询数据变更日志详情 响应体</summary>
// ************************************************************************
...
public record GetApaasV1ApplicationsByNamespaceAuditLogDataChangeLogDetailResponseDto
{
    ...
    public record AuditLogDetail
    {
        ...
        {
            /// <summary>
            /// <para>日志类型：10000-全部类型；10001-企业管理；10002-登录日志；10003-应用管理</para>
            /// <para>必填：否</para>
            /// <para>示例值：10000</para>
            /// <para>最大长度：1000</para>
            /// <para>最小长度：0</para>
            ...
            /// <summary>
            /// <para>审计域：15001-企业管理后台；15002-应用管理后台；15003-应用开发平台</para>
            /// <para>必填：否</para>
            /// <para>示例值：15001</para>
            /// <para>最大长度：1000</para>
            /// <para>最小长度：0</para>
