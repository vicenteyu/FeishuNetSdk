...
// ************************************************************************
// <copyright file="GetSearchV2SchemasBySchemaIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取数据范式 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetSearchV2SchemasBySchemaIdResponseDto
{
    /// <summary>
    /// <para>数据范式</para>
    /// <para>必填：否</para>
    ...
    public record SchemaSuffix
    {
        ...
        public record SchemaProperty
        {
            ...
            public SchemaSearchOptionsSuffix? SearchOptions { get; set; }

            /// <summary></summary>
            public record SchemaSearchOptionsSuffix
            {
                /// <summary>
