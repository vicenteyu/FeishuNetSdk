...
// ************************************************************************
// <copyright file="PostSheetsV2SpreadsheetsBySpreadsheetTokenSheetsBatchUpdate2ResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新工作表属性 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostSheetsV2SpreadsheetsBySpreadsheetTokenSheetsBatchUpdate2ResponseDto
{
    /// <summary>
    /// <para>本次操作工作表的结果</para>
    /// <para>必填：否</para>
    /// </summary>
        ...
        public record UpdateSheetSuffix
        {
            ...
            public record PropertiesSuffix
            {
                ...
                public record ProtectSuffix
                {
                    ...
                    /// <summary>
                    /// <para>除了本人与所有者外，其他拥有保护范围编辑权限的人员 ID。ID 类型由查询参数 user_id_type 决定。</para>
                    /// <para>必填：否</para>
                    /// </summary>
