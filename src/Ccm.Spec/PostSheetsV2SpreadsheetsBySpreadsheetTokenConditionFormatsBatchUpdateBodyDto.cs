...
// ************************************************************************
// <copyright file="PostSheetsV2SpreadsheetsBySpreadsheetTokenConditionFormatsBatchUpdateBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量更新条件格式 请求体</summary>
// ************************************************************************
...
public record PostSheetsV2SpreadsheetsBySpreadsheetTokenConditionFormatsBatchUpdateBodyDto
{
    ...
    public record SheetConditionFormat
    {
        ...
        {
            /// <summary>
            /// <para>需要更新的条件格式的 ID。可通过[获取条件格式](https://open.feishu.cn/document/ukTMukTMukTM/uATMzUjLwEzM14CMxMTN/conditionformat/condition-format-get)获取。</para>
            /// <para>必填：是</para>
            /// </summary>
