...
public record PostBitableV1AppsBodyDto
{
    ...
    /// <para>**注意**：</para>
    /// <para>请确保调用身份拥有在该文件夹中的编辑权限。详情参考[如何为应用开通云文档相关资源的权限](https://open.feishu.cn/document/uAjLw4CM/ugTN1YjL4UTN24CO1UjN/trouble-shooting/how-to-add-permissions-to-app)。</para>
    /// <para>必填：否</para>
