...
// ************************************************************************
// <copyright file="PostBitableV1AppsByAppTokenTablesByTableIdFieldsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>新增字段 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostBitableV1AppsByAppTokenTablesByTableIdFieldsResponseDto
{
    /// <summary>
    /// <para>字段</para>
    /// <para>必填：否</para>
        ...
        public record AppTableFieldProperty
        {
            ...
            public record AppFieldPropertyAutoSerial
            {
                ...
                public record AppFieldPropertyAutoSerialOptions
                {
                    ...
                    /// <para>可选值：<list type="bullet">
                    /// <item>system_number：自增数字位，value 范围 1-9</item>
