...
// ************************************************************************
// <copyright file="PostBaseV2AppsByAppTokenRolesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>新增自定义角色 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostBaseV2AppsByAppTokenRolesResponseDto
{
    /// <summary>
    /// <para>自定义角色</para>
    /// <para>必填：否</para>
    ...
    public PostBaseV2AppsByAppTokenRolesResponseDtoRole? Role { get; set; }

    /// <summary>
    /// <para>自定义角色</para>
    /// </summary>
    public record PostBaseV2AppsByAppTokenRolesResponseDtoRole
    {
        /// <summary>
        /// <para>自定义角色名称</para>
        /// <para>必填：是</para>
        ...
        public record TableRole
        {
            ...
            public record TableRoleRecRule
            {
                ...
                /// <summary>
                /// <para>命中 rec_rule 的记录对应的权限，可不设置，理论上应该与 table_perm 保持一致</para>
                /// <para>必填：否</para>
                /// <para>示例值：1</para>
                /// <para>可选值：<list type="bullet">
                /// <item>1：仅可阅读</item>
            ...
            /// <summary>
            /// <para>字段权限，仅在 `table_perm` 为 1 和 2 时生效。用于设置字段的可编辑或可阅读权限。类型为 map，key 是字段名称，value 是字段权限。value 枚举值有：</para>
            /// <para>- `1`：可阅读</para>
            /// <para>- `2`：可添加</para>
            /// <para>- `3`：可编辑</para>
            /// <para>必填：否</para>
