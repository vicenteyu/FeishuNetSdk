...
/// </summary>
public record PostDirectoryV1DepartmentsSearchResponseDto
{
    /// <summary>
    /// <para>部门信息</para>
    /// <para>必填：否</para>
    ...
    public PostDirectoryV1DepartmentsSearchResponseDtoPageResponse? PageResponse { get; set; }

    /// <summary>
    /// <para>分页结果</para>
    /// </summary>
    public record PostDirectoryV1DepartmentsSearchResponseDtoPageResponse
    {
        /// <summary>
        ...
        /// <para>必填：否</para>
        /// <para>示例值：aihsdniandafoafa</para>
        /// </summary>
