...
// ************************************************************************
// <copyright file="PutDirectoryV1CollaborationRulesByCollaborationRuleIdBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新可搜可见规则 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PutDirectoryV1CollaborationRulesByCollaborationRuleIdBodyDto
{
    /// <summary>
    ...
    {
        /// <summary>
        /// <para>用户 open id，可以使用通讯录/组织架构接口获取我方ID</para>
        /// <para>必填：否</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>部门 open id，0代表全部成员。可以使用通讯录/组织架构接口获取我方ID</para>
        /// <para>必填：否</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>用户组 open id，可以使用通讯录/组织架构接口获取我方ID</para>
        /// <para>必填：否</para>
        /// <para>最大长度：100</para>
        /// <para>最小长度：0</para>
        /// </summary>
