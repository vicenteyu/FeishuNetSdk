...
// ************************************************************************
// <copyright file="PostDirectoryV1EmployeesFilterResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取员工列表 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostDirectoryV1EmployeesFilterResponseDto
{
    /// <summary>
    /// <para>员工信息</para>
    /// <para>必填：否</para>
    ...
    public record EmployeeEntity
    {
        ...
        public record EmployeeBaseEntity
        {
            ...
            /// <para>员工在工作中的邮箱</para>
            /// <para>必填：否</para>
            /// <para>示例值：zhangsan@company.com</para>
            /// <para>最大长度：255</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>员工的企业邮箱别名。当成员希望针对不同人使用不同的邮箱地址进行邮件往来时，可为其企业邮箱添加别名。添加后，成员可使用别名发送邮件，也可接受发送至别名的邮件</para>
            /// <para>必填：否</para>
            /// <para>最大长度：20</para>
            /// <para>最小长度：0</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>离职时间。离职操作的时间，系统自动生成，无法写入。日期格式：YYYY-MM-DD</para>
            /// <para>必填：否</para>
            /// <para>示例值：2023-10-01</para>
            /// </summary>
    ...
    public PostDirectoryV1EmployeesFilterResponseDtoPageResponse? PageResponse { get; set; }

    /// <summary>
    /// <para>分页结果</para>
    /// </summary>
    public record PostDirectoryV1EmployeesFilterResponseDtoPageResponse
    {
        /// <summary>
        /// <para>是否还有后续结果，如果has_more为true，代表还有数据没有完全返回，需要使用响应结果中的page_token，并再次请求才能取得剩下的数据。</para>
        /// <para>必填：否</para>
        /// <para>示例值：1SQE23das</para>
        /// </summary>
