...
// ************************************************************************
// <copyright file="PostDirectoryV1EmployeesFilterBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取员工列表 请求体</summary>
// ************************************************************************
...
/// </summary>
public record PostDirectoryV1EmployeesFilterBodyDto
{
    /// <summary>
    ...
    public record MultiFilterCondition
    {
        ...
        {
            /// <summary>
            /// <para>筛选条件的左值，值为字段的参数名称。可选的筛选条件有：</para>
            /// <para>- base_info.mobile</para>
            /// <para>- base_info.email</para>
            /// <para>- base_info.departments.department_id和work_info.staff_status（需同时指定）</para>
            /// <para>- work_info.job_number</para>
            /// <para>必填：是</para>
            /// <para>示例值：base_info.mobile</para>
            /// </summary>
            [JsonPropertyName("field")]
            public string Field { get; set; } = string.Empty;

            /// <summary>
            /// <para>比较操作符。可选值有：</para>
            /// <para>- eq：等于，支持任何类型的左值</para>
            /// <para>- in：属于任一</para>
            /// <para>各个字段支持的操作符可能不同，具体见[了解更多：查询条件用法](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/directory-v1/filter-usage)</para>
            /// <para>必填：是</para>
            /// <para>示例值：eq</para>
            /// </summary>
            ...
            /// <summary>
            /// <para>筛选条件的右值，为转义后的json字符串。</para>
            /// <para>- eq匹配字符串，使用 `"\"str\""`</para>
            /// <para>- in匹配字符串列表，使用 `"[\"str\"]"`</para>
            /// <para>- eq匹配数字，使用 `"123"`</para>
            /// <para>- in匹配数字列表，使用 `"[123]"`</para>
            /// <para>必填：是</para>
            /// <para>示例值：`\"8619922333322\"`</para>
            /// </summary>
