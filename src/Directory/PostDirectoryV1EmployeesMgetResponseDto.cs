...
/// </summary>
public record PostDirectoryV1EmployeesMgetResponseDto
{
    /// <summary>
    /// <para>员工信息</para>
    /// <para>必填：否</para>
    ...
    public record EmployeeEntity
    {
        ...
        public record EmployeeBaseEntity
        {
            ...
            /// <para>企业邮箱</para>
            /// <para>必填：否</para>
            /// <para>示例值：员工的企业邮箱。请先确保已在管理后台启用飞书邮箱服务。企业邮箱的域名需要企业在管理后台申请并开启。如果企业没有开启对应域名的企业邮箱，设置用户的企业邮箱会操作失败。</para>
            /// <para>最大长度：255</para>
            /// </summary>
