...
// ************************************************************************
// <copyright file="CalendarCalendarAclCreatedV4EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建 ACL 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Calendar.Events;
/// <summary>
/// 创建 ACL 事件体
/// <para>当订阅的日历上有访问控制被创建时，将会触发此事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=calendar&amp;version=v4&amp;resource=calendar.acl&amp;event=created)</para>
...
/// </summary>
public record CalendarCalendarAclCreatedV4EventBodyDto() : EventBodyDto("calendar.calendar.acl.created_v4")
{
    /// <summary>
