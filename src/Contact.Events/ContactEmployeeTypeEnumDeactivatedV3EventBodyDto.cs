...
// ************************************************************************
// <copyright file="ContactEmployeeTypeEnumDeactivatedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>停用人员类型 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Contact.Events;
/// <summary>
/// 停用人员类型 事件体
/// <para>当应用订阅该事件后，如果将激活的人员类型更新为未激活状态，则会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&amp;version=v3&amp;resource=employee_type_enum&amp;event=deactivated)</para>
...
/// </summary>
public record ContactEmployeeTypeEnumDeactivatedV3EventBodyDto() : EventBodyDto("contact.employee_type_enum.deactivated_v3")
{
    /// <summary>
