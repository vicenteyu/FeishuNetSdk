...
// ************************************************************************
// <copyright file="ContactDepartmentDeletedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>部门被删除 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Contact.Events;
/// <summary>
/// 部门被删除 事件体
/// <para>应用订阅该事件后，如果通讯录内有部门被删除，则会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&amp;version=v3&amp;resource=department&amp;event=deleted)</para>
/// <para>接口ID：6954228303264120859</para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/contact-v3/department/events/deleted</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2freference%2fcontact-v3%2fdepartment%2fevents%2fdeleted</para>
/// </summary>
public record ContactDepartmentDeletedV3EventBodyDto() : EventBodyDto("contact.department.deleted_v3")
{
    /// <summary>
    /// <para>部门信息。</para>
    /// <para>必填：否</para>
    ...
    /// 
    /// </summary>
    public record OldDepartmentObject
    {
        /// <summary>
        /// <para>部门状态。</para>
        /// <para>**字段权限要求（满足任一）**：</para>
