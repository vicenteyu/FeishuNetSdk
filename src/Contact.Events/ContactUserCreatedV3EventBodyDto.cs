...
// ************************************************************************
// <copyright file="ContactUserCreatedV3EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>员工入职 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Contact.Events;
/// <summary>
/// 员工入职 事件体
/// <para>当应用订阅该事件后，如果有新员工入职（例如，通过管理后台添加成员、调用创建用户 API），则会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=contact&amp;version=v3&amp;resource=user&amp;event=created)</para>
/// <para>接口ID：6954228303264088091</para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/contact-v3/user/events/created</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2freference%2fcontact-v3%2fuser%2fevents%2fcreated</para>
/// </summary>
public record ContactUserCreatedV3EventBodyDto() : EventBodyDto("contact.user.created_v3")
{
    /// <summary>
    /// <para>员工信息。</para>
    /// <para>必填：否</para>
