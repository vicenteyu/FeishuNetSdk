...
// ************************************************************************
// <copyright file="OutApprovalRevertEventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>审批通过并撤销 事件体</summary>
// ************************************************************************
...
/// </summary>
public record OutApprovalRevertEventBodyDto() : EventBodyDto("out_approval_revert")
{
    /// <summary>
    ...
    /// <summary>
    /// <para>事件类型。固定值 `out_approval_revert`</para>
    /// <para>必填：否</para>
    /// </summary>
