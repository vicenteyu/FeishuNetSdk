...
/// </summary>
public record GetCalendarV4CalendarsByCalendarIdAclsResponseDto : IPageableResponse<GetCalendarV4CalendarsByCalendarIdAclsResponseDto.CalendarAcl>
{
    /// <inheritdoc/>
    [JsonIgnore]
    public CalendarAcl[]? Items => Acls;
