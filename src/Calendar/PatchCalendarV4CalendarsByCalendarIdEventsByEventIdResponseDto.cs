...
/// </summary>
public record PatchCalendarV4CalendarsByCalendarIdEventsByEventIdResponseDto
{
    /// <summary>
    /// <para>更新后的日程实体信息。</para>
    /// <para>必填：否</para>
    /// </summary>
