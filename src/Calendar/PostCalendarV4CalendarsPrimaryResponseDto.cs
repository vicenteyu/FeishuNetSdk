...
// ************************************************************************
// <copyright file="PostCalendarV4CalendarsPrimaryResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询主日历信息 响应体</summary>
// ************************************************************************
...
public record PostCalendarV4CalendarsPrimaryResponseDto
{
    ...
    public record UserCalendar
    {
        ...
        {
            /// <summary>
            /// <para>日历 ID。你可以通过该 ID 查询、更新主日历信息。更多信息可参见[日历 ID 字段说明](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar/introduction)。</para>
            /// <para>必填：是</para>
