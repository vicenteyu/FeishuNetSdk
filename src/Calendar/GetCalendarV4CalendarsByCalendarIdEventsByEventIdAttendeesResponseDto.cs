...
/// </summary>
public record GetCalendarV4CalendarsByCalendarIdEventsByEventIdAttendeesResponseDto
{
    /// <summary>
    /// <para>日程的参与者列表</para>
    /// <para>必填：否</para>
    ...
    public record CalendarEventAttendee
    {
        ...
        /// <para>当前字段已废弃，如需获取群中的群成员,请使用 [获取参与人群成员列表](https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/calendar-v4/calendar-event-attendee-chat_member/list)</para>
        /// <para>必填：否</para>
        /// </summary>
