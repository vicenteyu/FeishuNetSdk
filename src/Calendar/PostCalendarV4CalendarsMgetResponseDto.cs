...
// ************************************************************************
// <copyright file="PostCalendarV4CalendarsMgetResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量查询日历信息 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostCalendarV4CalendarsMgetResponseDto
{
    /// <summary>
    /// <para>日历列表。</para>
    /// <para>必填：否</para>
