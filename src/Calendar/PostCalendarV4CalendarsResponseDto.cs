...
// ************************************************************************
// <copyright file="PostCalendarV4CalendarsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>创建共享日历 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostCalendarV4CalendarsResponseDto
{
    /// <summary>
    ...
    public PostCalendarV4CalendarsResponseDtoCalendar? Calendar { get; set; }

    /// <summary>
    /// <para>新创建的日历实体信息。</para>
    /// </summary>
    public record PostCalendarV4CalendarsResponseDtoCalendar
    {
        /// <summary>
