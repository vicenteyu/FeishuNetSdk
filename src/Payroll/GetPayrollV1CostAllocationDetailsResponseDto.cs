...
// ************************************************************************
// <copyright file="GetPayrollV1CostAllocationDetailsResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>查询成本分摊报表明细 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetPayrollV1CostAllocationDetailsResponseDto
{
    /// <summary>
    /// <para>报表明细数据</para>
    /// <para>必填：否</para>
    ...
    public record CostAllocationReportData
    {
        ...
        /// <para>员工id</para>
        /// <para>必填：否</para>
        /// <para>示例值：72321836123692186</para>
        /// <para>最大长度：64</para>
        /// <para>最小长度：0</para>
        /// </summary>
    ...
    public record I18nContent
    {
        ...
        /// <para>对应的接口映射如下：</para>
        /// <para>dimension_type = 13 算薪项</para>
        /// </summary>
        [JsonPropertyName("id")]
        public string? Id { get; set; }
    }
