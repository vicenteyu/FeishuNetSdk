...
// ************************************************************************
// <copyright file="ImMessageReactionCreatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>新增消息表情回复 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Im.Events;
/// <summary>
/// 新增消息表情回复 事件体
/// <para>应用订阅该事件后，消息被添加表情回复时会触发此事件。事件体包含被添加表情回复的消息 message_id、添加表情回复的操作人 ID、表情类型、添加时间等信息。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=im&amp;version=v1&amp;resource=message.reaction&amp;event=created)</para>
...
/// </summary>
public record ImMessageReactionCreatedV1EventBodyDto() : EventBodyDto("im.message.reaction.created_v1")
{
    /// <summary>
