...
// ************************************************************************
// <copyright file="VcMeetingParticipantMeetingEndedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>参与的会议结束 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Vc.Events;
/// <summary>
/// 参与的会议结束 事件体
/// <para>当用户加入过的会议结束后，将会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=meeting&amp;event=participant_meeting_ended)</para>
/// <para>接口ID：7644841241633999819</para>
/// <para>文档地址：https://open.feishu.cn/document/uAjLw4CM/ukTMukTMukTM/reference/vc-v1/meeting/events/participant_meeting_ended</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2freference%2fvc-v1%2fmeeting%2fevents%2fparticipant_meeting_ended</para>
/// </summary>
public record VcMeetingParticipantMeetingEndedV1EventBodyDto() : EventBodyDto("vc.meeting.participant_meeting_ended_v1")
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
