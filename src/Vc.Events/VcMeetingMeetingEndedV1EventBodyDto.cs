...
// ************************************************************************
// <copyright file="VcMeetingMeetingEndedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <summary>
/// 会议结束 事件体
/// <para>发生在会议结束时【仅通过Open API预约的会议会产生此类事件】{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=meeting&amp;event=meeting_ended)</para>
/// <para>接口ID：6921909217674887195</para>
/// <para>文档地址：https://open.feishu.cn/document/server-docs/vc-v1/meeting/events/meeting_ended</para>
/// <para>JSON地址：https://open.feishu.cn/document_portal/v1/document/get_detail?fullPath=%2fuAjLw4CM%2fukTMukTMukTM%2freference%2fvc-v1%2fmeeting%2fevents%2fmeeting_ended</para>
/// </summary>
public record VcMeetingMeetingEndedV1EventBodyDto() : EventBodyDto("vc.meeting.meeting_ended_v1")
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
