...
// ************************************************************************
// <copyright file="VcRoomUpdatedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>更新会议室 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Vc.Events;
/// <summary>
/// 更新会议室 事件体
/// <para>当更新会议室时，会触发该事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=room&amp;event=updated)</para>
...
/// </summary>
public record VcRoomUpdatedV1EventBodyDto() : EventBodyDto("vc.room.updated_v1")
{
    /// <summary>
    /// <para>会议室详情</para>
    /// <para>必填：否</para>
