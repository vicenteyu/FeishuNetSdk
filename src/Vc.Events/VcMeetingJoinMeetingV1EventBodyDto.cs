...
// ************************************************************************
// <copyright file="VcMeetingJoinMeetingV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>加入会议 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Vc.Events;
/// <summary>
/// 加入会议 事件体
/// <para>发生在有人加入会议时【仅通过Open API预约的会议会产生此类事件】{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=meeting&amp;event=join_meeting)</para>
...
/// </summary>
public record VcMeetingJoinMeetingV1EventBodyDto() : EventBodyDto("vc.meeting.join_meeting_v1")
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
