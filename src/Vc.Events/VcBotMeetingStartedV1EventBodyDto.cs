...
// ************************************************************************
// <copyright file="VcBotMeetingStartedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
...
/// <summary>
/// 会议开始 事件体
/// <para>当会议开始时，系统会向订阅方推送此事件。{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=bot&amp;event=meeting_started)</para>
...
/// </summary>
public record VcBotMeetingStartedV1EventBodyDto() : EventBodyDto("vc.bot.meeting_started_v1")
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
