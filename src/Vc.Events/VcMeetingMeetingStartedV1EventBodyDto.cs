...
// ************************************************************************
// <copyright file="VcMeetingMeetingStartedV1EventBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>会议开始 事件体</summary>
// ************************************************************************
namespace FeishuNetSdk.Vc.Events;
/// <summary>
/// 会议开始 事件体
/// <para>发生在会议开始时【仅通过Open API预约的会议会产生此类事件】{使用示例}(url=/api/tools/api_explore/api_explore_config?project=vc&amp;version=v1&amp;resource=meeting&amp;event=meeting_started)</para>
...
/// </summary>
public record VcMeetingMeetingStartedV1EventBodyDto() : EventBodyDto("vc.meeting.meeting_started_v1")
{
    /// <summary>
    /// <para>会议数据</para>
    /// <para>必填：否</para>
