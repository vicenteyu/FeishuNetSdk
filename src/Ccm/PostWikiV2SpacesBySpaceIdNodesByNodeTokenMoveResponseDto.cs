...
// ************************************************************************
// <copyright file="PostWikiV2SpacesBySpaceIdNodesByNodeTokenMoveResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>移动知识空间节点 响应体</summary>
// ************************************************************************
...
/// </summary>
public record PostWikiV2SpacesBySpaceIdNodesByNodeTokenMoveResponseDto
{
    /// <summary>
    /// <para>移动后的节点信息</para>
    /// <para>必填：否</para>
    ...
    public PostWikiV2SpacesBySpaceIdNodesByNodeTokenMoveResponseDtoNode? Node { get; set; }

    /// <summary>
    /// <para>移动后的节点信息</para>
    /// </summary>
    public record PostWikiV2SpacesBySpaceIdNodesByNodeTokenMoveResponseDtoNode
    {
        /// <summary>
        /// <para>知识空间id</para>
