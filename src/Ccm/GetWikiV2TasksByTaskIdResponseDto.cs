...
// ************************************************************************
// <copyright file="GetWikiV2TasksByTaskIdResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取任务结果 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetWikiV2TasksByTaskIdResponseDto
{
    /// <summary>
    /// <para>任务结果</para>
    /// <para>必填：是</para>
    ...
    public TaskResult Task { get; set; } = new();
    ...
    public record TaskResult
    {
        ...
        /// <summary>
        /// <para>[移动云空间文档至知识空间](https://open.feishu.cn/document/ukTMukTMukTM/uUDN04SN0QjL1QDN/wiki-v2/space-node/move_docs_to_wiki)任务结果</para>
        /// <para>必填：否</para>
        /// </summary>
        [JsonPropertyName("move_result")]
        public MoveResult[]? MoveResults { get; set; }
