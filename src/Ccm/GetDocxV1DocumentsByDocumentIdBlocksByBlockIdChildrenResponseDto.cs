...
/// </summary>
public record GetDocxV1DocumentsByDocumentIdBlocksByBlockIdChildrenResponseDto : IPageableResponse<GetDocxV1DocumentsByDocumentIdBlocksByBlockIdChildrenResponseDto.Block>
{
    /// <summary>
