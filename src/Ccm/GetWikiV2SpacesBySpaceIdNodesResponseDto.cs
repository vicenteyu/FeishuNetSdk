...
// ************************************************************************
// <copyright file="GetWikiV2SpacesBySpaceIdNodesResponseDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>获取知识空间子节点列表 响应体</summary>
// ************************************************************************
...
/// </summary>
public record GetWikiV2SpacesBySpaceIdNodesResponseDto : IPageableResponse<GetWikiV2SpacesBySpaceIdNodesResponseDto.Node>
{
    /// <summary>
    /// <para>数据列表</para>
    /// <para>必填：否</para>
