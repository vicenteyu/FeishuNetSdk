...
// ************************************************************************
// <copyright file="PostDriveV1FilesByFileTokenCommentsBatchQueryBodyDto.cs" company="Vicente Yu">
//     MIT
// </copyright>
// <summary>批量获取评论 请求体</summary>
// ************************************************************************
...
{
    /// <summary>
    /// <para>需要获取数据的评论 ID ，可通过调用获取云文档所有评论接口获取 comment_id，允许的最大元素个数为100</para>
    /// <para>必填：是</para>
