...
/// </summary>
public record PostWorkplaceV1CustomWorkplaceAccessDataSearchResponseDto : IPageableResponse<PostWorkplaceV1CustomWorkplaceAccessDataSearchResponseDto.CustomWorkplaceAccessData>
{
    /// <summary>
    /// <para>定制工作台访问数据</para>
    /// <para>必填：否</para>
