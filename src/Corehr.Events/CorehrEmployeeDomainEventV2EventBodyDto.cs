...
public record CorehrEmployeeDomainEventV2EventBodyDto() : EventBodyDto("corehr.employee.domain_event_v2")
{
    ...
    /// <para>子事件类型</para>
    /// <para>**可选值有**：</para>
    /// <para>1001:新入职,2001:更新人员信息,4001:创建兼职,4002:编缉兼职（更新兼职的任一字段就会触发该事件，包括更新【结束日期】）,4003:撤销兼职（弃用）,4004:结束兼职（目前含义为数据变更，即首次设置【结束日期】时会触发）,4005:删除兼职,5001:添动异动,5002:编辑异动信息,5003:撤销异动,7001:离职通过,7002:撤销离职,8001:开始记录,8002:添加记录版本,8003:编辑记录版本</para>
    /// <para>必填：否</para>
    /// <para>可选值：<list type="bullet">
    /// <item>1001：新入职</item>
    ...
    /// <item>7002：撤销离职</item>
    /// <item>8001：开始记录</item>
    /// <item>8002：添加记录版本</item>
    /// <item>8003：编辑记录版本</item>
    /// </list></para>
    /// </summary>
